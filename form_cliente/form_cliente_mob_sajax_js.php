  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idcliente
  function do_ajax_form_cliente_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldHidden(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_cliente_mob_validate_idcliente_cb);
  } // do_ajax_form_cliente_mob_validate_idcliente

  function do_ajax_form_cliente_mob_validate_idcliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_idcliente_cb

  // ---------- Validate nombrecli
  function do_ajax_form_cliente_mob_validate_nombrecli()
  {
    var nomeCampo_nombrecli = "nombrecli";
    var var_nombrecli = scAjaxGetFieldText(nomeCampo_nombrecli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_nombrecli(var_nombrecli, var_script_case_init, do_ajax_form_cliente_mob_validate_nombrecli_cb);
  } // do_ajax_form_cliente_mob_validate_nombrecli

  function do_ajax_form_cliente_mob_validate_nombrecli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombrecli";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_nombrecli_cb

  // ---------- Validate apellidocli
  function do_ajax_form_cliente_mob_validate_apellidocli()
  {
    var nomeCampo_apellidocli = "apellidocli";
    var var_apellidocli = scAjaxGetFieldText(nomeCampo_apellidocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_apellidocli(var_apellidocli, var_script_case_init, do_ajax_form_cliente_mob_validate_apellidocli_cb);
  } // do_ajax_form_cliente_mob_validate_apellidocli

  function do_ajax_form_cliente_mob_validate_apellidocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apellidocli";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_apellidocli_cb

  // ---------- Validate telefonocli
  function do_ajax_form_cliente_mob_validate_telefonocli()
  {
    var nomeCampo_telefonocli = "telefonocli";
    var var_telefonocli = scAjaxGetFieldText(nomeCampo_telefonocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_telefonocli(var_telefonocli, var_script_case_init, do_ajax_form_cliente_mob_validate_telefonocli_cb);
  } // do_ajax_form_cliente_mob_validate_telefonocli

  function do_ajax_form_cliente_mob_validate_telefonocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telefonocli";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_telefonocli_cb

  // ---------- Validate correocli
  function do_ajax_form_cliente_mob_validate_correocli()
  {
    var nomeCampo_correocli = "correocli";
    var var_correocli = scAjaxGetFieldText(nomeCampo_correocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_correocli(var_correocli, var_script_case_init, do_ajax_form_cliente_mob_validate_correocli_cb);
  } // do_ajax_form_cliente_mob_validate_correocli

  function do_ajax_form_cliente_mob_validate_correocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correocli";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_correocli_cb

  // ---------- Validate dnicli
  function do_ajax_form_cliente_mob_validate_dnicli()
  {
    var nomeCampo_dnicli = "dnicli";
    var var_dnicli = scAjaxGetFieldText(nomeCampo_dnicli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_dnicli(var_dnicli, var_script_case_init, do_ajax_form_cliente_mob_validate_dnicli_cb);
  } // do_ajax_form_cliente_mob_validate_dnicli

  function do_ajax_form_cliente_mob_validate_dnicli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dnicli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_dnicli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcliente = scAjaxGetFieldHidden("idcliente");
    var var_nombrecli = scAjaxGetFieldText("nombrecli");
    var var_apellidocli = scAjaxGetFieldText("apellidocli");
    var var_telefonocli = scAjaxGetFieldText("telefonocli");
    var var_correocli = scAjaxGetFieldText("correocli");
    var var_dnicli = scAjaxGetFieldText("dnicli");
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mob_submit_form(var_idcliente, var_nombrecli, var_apellidocli, var_telefonocli, var_correocli, var_dnicli, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_mob_submit_form_cb);
  } // do_ajax_form_cliente_mob_submit_form

  function do_ajax_form_cliente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombrecli");
      scAjaxHideErrorDisplay("apellidocli");
      scAjaxHideErrorDisplay("telefonocli");
      scAjaxHideErrorDisplay("correocli");
      scAjaxHideErrorDisplay("dnicli");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_mob_submit_form_cb
  function do_ajax_form_cliente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_mob_navigate_form();
    }
  }

  function perform_ajax_form_cliente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mob_navigate_form(var_idcliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_mob_navigate_form_cb);
  } // do_ajax_form_cliente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_mob_navigate_form_cb
  function do_ajax_form_cliente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cliente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cliente_mob_navigate_form_cb_after_alert

  function sc_hide_form_cliente_mob_form()
  {
  ...
  ajax_field_list[1] = "nombrecli";
  ajax_field_list[2] = "apellidocli";
  ajax_field_list[3] = "telefonocli";
  ajax_field_list[4] = "correocli";
  ajax_field_list[5] = "dnicli";
  ...
  var ajax_error_list = {
    ...
    "nombrecli": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apellidocli": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telefonocli": {"label": "Telefono", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "correocli": {"label": "Correo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dnicli": {"label": "Dni", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idcliente": new Array(),
    "nombrecli": new Array(),
    "apellidocli": new Array(),
    "telefonocli": new Array(),
    "correocli": new Array(),
    "dnicli": new Array()
  };
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["nombrecli"][1] = "nombrecli";
  ajax_field_mult["apellidocli"][1] = "apellidocli";
  ajax_field_mult["telefonocli"][1] = "telefonocli";
  ajax_field_mult["correocli"][1] = "correocli";
  ajax_field_mult["dnicli"][1] = "dnicli";

  var ajax_field_id = {
    "idcliente": new Array("hidden_field_label_idcliente", "hidden_field_data_idcliente"),
    "nombrecli": new Array("hidden_field_label_nombrecli", "hidden_field_data_nombrecli"),
    "apellidocli": new Array("hidden_field_label_apellidocli", "hidden_field_data_apellidocli"),
    "telefonocli": new Array("hidden_field_label_telefonocli", "hidden_field_data_telefonocli"),
    "correocli": new Array("hidden_field_label_correocli", "hidden_field_data_correocli"),
    "dnicli": new Array("hidden_field_label_dnicli", "hidden_field_data_dnicli")
  };
