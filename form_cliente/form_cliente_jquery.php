...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idcliente' + iSeqRow).bind('blur', function() { sc_form_cliente_idcliente_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cliente_idcliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombrecli' + iSeqRow).bind('blur', function() { sc_form_cliente_nombrecli_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cliente_nombrecli_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_apellidocli' + iSeqRow).bind('blur', function() { sc_form_cliente_apellidocli_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_cliente_apellidocli_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_telefonocli' + iSeqRow).bind('blur', function() { sc_form_cliente_telefonocli_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_cliente_telefonocli_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_correocli' + iSeqRow).bind('blur', function() { sc_form_cliente_correocli_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cliente_correocli_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dnicli' + iSeqRow).bind('blur', function() { sc_form_cliente_dnicli_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_cliente_dnicli_onchange(this, iSeqRow) })
...
function sc_form_cliente_idcliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cliente_nombrecli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cliente_apellidocli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cliente_telefonocli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cliente_correocli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cliente_dnicli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_cliente_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cliente')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
