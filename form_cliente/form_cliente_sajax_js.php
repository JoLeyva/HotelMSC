  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idcliente
  function do_ajax_form_cliente_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldHidden(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_cliente_validate_idcliente_cb);
  } // do_ajax_form_cliente_validate_idcliente

  function do_ajax_form_cliente_validate_idcliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_idcliente_cb

  // ---------- Validate nombrecli
  function do_ajax_form_cliente_validate_nombrecli()
  {
    var nomeCampo_nombrecli = "nombrecli";
    var var_nombrecli = scAjaxGetFieldText(nomeCampo_nombrecli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_nombrecli(var_nombrecli, var_script_case_init, do_ajax_form_cliente_validate_nombrecli_cb);
  } // do_ajax_form_cliente_validate_nombrecli

  function do_ajax_form_cliente_validate_nombrecli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_nombrecli_cb

  // ---------- Validate apellidocli
  function do_ajax_form_cliente_validate_apellidocli()
  {
    var nomeCampo_apellidocli = "apellidocli";
    var var_apellidocli = scAjaxGetFieldText(nomeCampo_apellidocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_apellidocli(var_apellidocli, var_script_case_init, do_ajax_form_cliente_validate_apellidocli_cb);
  } // do_ajax_form_cliente_validate_apellidocli

  function do_ajax_form_cliente_validate_apellidocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_apellidocli_cb

  // ---------- Validate telefonocli
  function do_ajax_form_cliente_validate_telefonocli()
  {
    var nomeCampo_telefonocli = "telefonocli";
    var var_telefonocli = scAjaxGetFieldText(nomeCampo_telefonocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_telefonocli(var_telefonocli, var_script_case_init, do_ajax_form_cliente_validate_telefonocli_cb);
  } // do_ajax_form_cliente_validate_telefonocli

  function do_ajax_form_cliente_validate_telefonocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_telefonocli_cb

  // ---------- Validate correocli
  function do_ajax_form_cliente_validate_correocli()
  {
    var nomeCampo_correocli = "correocli";
    var var_correocli = scAjaxGetFieldText(nomeCampo_correocli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_correocli(var_correocli, var_script_case_init, do_ajax_form_cliente_validate_correocli_cb);
  } // do_ajax_form_cliente_validate_correocli

  function do_ajax_form_cliente_validate_correocli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_correocli_cb

  // ---------- Validate dnicli
  function do_ajax_form_cliente_validate_dnicli()
  {
    var nomeCampo_dnicli = "dnicli";
    var var_dnicli = scAjaxGetFieldText(nomeCampo_dnicli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_dnicli(var_dnicli, var_script_case_init, do_ajax_form_cliente_validate_dnicli_cb);
  } // do_ajax_form_cliente_validate_dnicli

  function do_ajax_form_cliente_validate_dnicli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dnicli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_dnicli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_submit_form(var_idcliente, var_nombrecli, var_apellidocli, var_telefonocli, var_correocli, var_dnicli, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_submit_form_cb
  function do_ajax_form_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_navigate_form();
    }
  }

  function perform_ajax_form_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_navigate_form(var_idcliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_navigate_form_cb);
  } // do_ajax_form_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_navigate_form_cb
  function do_ajax_form_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cliente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cliente_navigate_form_cb_after_alert

  function sc_hide_form_cliente_form()
  {
