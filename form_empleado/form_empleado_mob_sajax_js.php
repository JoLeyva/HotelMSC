  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empleado_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_empleado_mob_form();
	}
...
?>
  ...
  // ---------- Validate idempleado
  function do_ajax_form_empleado_mob_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldHidden(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_mob_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_empleado_mob_validate_idempleado_cb);
  } // do_ajax_form_empleado_mob_validate_idempleado

  function do_ajax_form_empleado_mob_validate_idempleado_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_idempleado_cb

  // ---------- Validate idcargo
  function do_ajax_form_empleado_mob_validate_idcargo()
  {
    var nomeCampo_idcargo = "idcargo";
    var var_idcargo = scAjaxGetFieldSelect(nomeCampo_idcargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_mob_validate_idcargo(var_idcargo, var_script_case_init, do_ajax_form_empleado_mob_validate_idcargo_cb);
  } // do_ajax_form_empleado_mob_validate_idcargo

  function do_ajax_form_empleado_mob_validate_idcargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcargo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_idcargo_cb

  // ---------- Validate nombreemp
  function do_ajax_form_empleado_mob_validate_nombreemp()
  {
    var nomeCampo_nombreemp = "nombreemp";
    var var_nombreemp = scAjaxGetFieldText(nomeCampo_nombreemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_mob_validate_nombreemp(var_nombreemp, var_script_case_init, do_ajax_form_empleado_mob_validate_nombreemp_cb);
  } // do_ajax_form_empleado_mob_validate_nombreemp

  function do_ajax_form_empleado_mob_validate_nombreemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_nombreemp_cb

  // ---------- Validate apellidoemp
  function do_ajax_form_empleado_mob_validate_apellidoemp()
  {
    var nomeCampo_apellidoemp = "apellidoemp";
    var var_apellidoemp = scAjaxGetFieldText(nomeCampo_apellidoemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_mob_validate_apellidoemp(var_apellidoemp, var_script_case_init, do_ajax_form_empleado_mob_validate_apellidoemp_cb);
  } // do_ajax_form_empleado_mob_validate_apellidoemp

  function do_ajax_form_empleado_mob_validate_apellidoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_apellidoemp_cb

  // ---------- Validate dniemp
  function do_ajax_form_empleado_mob_validate_dniemp()
  {
    var nomeCampo_dniemp = "dniemp";
    var var_dniemp = scAjaxGetFieldText(nomeCampo_dniemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_mob_validate_dniemp(var_dniemp, var_script_case_init, do_ajax_form_empleado_mob_validate_dniemp_cb);
  } // do_ajax_form_empleado_mob_validate_dniemp

  function do_ajax_form_empleado_mob_validate_dniemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dniemp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_dniemp_cb

  // ---------- Validate fechacontratoemp
  function do_ajax_form_empleado_mob_validate_fechacontratoemp()
  {
    ...
    setTimeout(function() {
      var var_fechacontratoemp = scAjaxGetFieldText(nomeCampo_fechacontratoemp);
      x_ajax_form_empleado_mob_validate_fechacontratoemp(var_fechacontratoemp, var_script_case_init, do_ajax_form_empleado_mob_validate_fechacontratoemp_cb);
    }, 200);
  } // do_ajax_form_empleado_mob_validate_fechacontratoemp

  function do_ajax_form_empleado_mob_validate_fechacontratoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_mob_validate_fechacontratoemp_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empleado_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleado_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_empleado_mob_submit_form(var_idempleado, var_idcargo, var_nombreemp, var_apellidoemp, var_dniemp, var_fechacontratoemp, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empleado_mob_submit_form_cb);
  } // do_ajax_form_empleado_mob_submit_form

  function do_ajax_form_empleado_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empleado_mob_submit_form_cb_after_alert);
  } // do_ajax_form_empleado_mob_submit_form_cb
  function do_ajax_form_empleado_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empleado_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_empleado_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empleado_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_empleado_mob_navigate_form();
    }
  }

  function perform_ajax_form_empleado_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_empleado_mob_navigate_form(var_idempleado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empleado_mob_navigate_form_cb);
  } // do_ajax_form_empleado_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empleado_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empleado_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_empleado_mob_navigate_form_cb
  function do_ajax_form_empleado_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empleado_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empleado_mob_navigate_form_cb_after_alert

  function sc_hide_form_empleado_mob_form()
  {
