  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empleado" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idempleado
  function do_ajax_form_empleado_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldHidden(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_empleado_validate_idempleado_cb);
  } // do_ajax_form_empleado_validate_idempleado

  function do_ajax_form_empleado_validate_idempleado_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_idempleado_cb

  // ---------- Validate idcargo
  function do_ajax_form_empleado_validate_idcargo()
  {
    var nomeCampo_idcargo = "idcargo";
    var var_idcargo = scAjaxGetFieldSelect(nomeCampo_idcargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_validate_idcargo(var_idcargo, var_script_case_init, do_ajax_form_empleado_validate_idcargo_cb);
  } // do_ajax_form_empleado_validate_idcargo

  function do_ajax_form_empleado_validate_idcargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcargo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_idcargo_cb

  // ---------- Validate nombreemp
  function do_ajax_form_empleado_validate_nombreemp()
  {
    var nomeCampo_nombreemp = "nombreemp";
    var var_nombreemp = scAjaxGetFieldText(nomeCampo_nombreemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_validate_nombreemp(var_nombreemp, var_script_case_init, do_ajax_form_empleado_validate_nombreemp_cb);
  } // do_ajax_form_empleado_validate_nombreemp

  function do_ajax_form_empleado_validate_nombreemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombreemp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_nombreemp_cb

  // ---------- Validate apellidoemp
  function do_ajax_form_empleado_validate_apellidoemp()
  {
    var nomeCampo_apellidoemp = "apellidoemp";
    var var_apellidoemp = scAjaxGetFieldText(nomeCampo_apellidoemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_validate_apellidoemp(var_apellidoemp, var_script_case_init, do_ajax_form_empleado_validate_apellidoemp_cb);
  } // do_ajax_form_empleado_validate_apellidoemp

  function do_ajax_form_empleado_validate_apellidoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apellidoemp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_apellidoemp_cb

  // ---------- Validate dniemp
  function do_ajax_form_empleado_validate_dniemp()
  {
    var nomeCampo_dniemp = "dniemp";
    var var_dniemp = scAjaxGetFieldText(nomeCampo_dniemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleado_validate_dniemp(var_dniemp, var_script_case_init, do_ajax_form_empleado_validate_dniemp_cb);
  } // do_ajax_form_empleado_validate_dniemp

  function do_ajax_form_empleado_validate_dniemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dniemp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_dniemp_cb

  // ---------- Validate fechacontratoemp
  function do_ajax_form_empleado_validate_fechacontratoemp()
  {
    var nomeCampo_fechacontratoemp = "fechacontratoemp";
    var var_fechacontratoemp = scAjaxGetFieldText(nomeCampo_fechacontratoemp);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechacontratoemp = scAjaxGetFieldText(nomeCampo_fechacontratoemp);
      x_ajax_form_empleado_validate_fechacontratoemp(var_fechacontratoemp, var_script_case_init, do_ajax_form_empleado_validate_fechacontratoemp_cb);
    }, 200);
  } // do_ajax_form_empleado_validate_fechacontratoemp

  function do_ajax_form_empleado_validate_fechacontratoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechacontratoemp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleado_validate_fechacontratoemp_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empleado_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleado_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idempleado = scAjaxGetFieldHidden("idempleado");
    var var_idcargo = scAjaxGetFieldSelect("idcargo");
    var var_nombreemp = scAjaxGetFieldText("nombreemp");
    var var_apellidoemp = scAjaxGetFieldText("apellidoemp");
    var var_dniemp = scAjaxGetFieldText("dniemp");
    var var_fechacontratoemp = scAjaxGetFieldText("fechacontratoemp");
    ...
    scAjaxProcOn();
    x_ajax_form_empleado_submit_form(var_idempleado, var_idcargo, var_nombreemp, var_apellidoemp, var_dniemp, var_fechacontratoemp, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empleado_submit_form_cb);
  } // do_ajax_form_empleado_submit_form

  function do_ajax_form_empleado_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombreemp");
      scAjaxHideErrorDisplay("apellidoemp");
      scAjaxHideErrorDisplay("dniemp");
      scAjaxHideErrorDisplay("fechacontratoemp");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empleado_submit_form_cb_after_alert);
  } // do_ajax_form_empleado_submit_form_cb
  function do_ajax_form_empleado_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empleado_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_empleado_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empleado_navigate_form, function() {});
    } else {
      perform_ajax_form_empleado_navigate_form();
    }
  }

  function perform_ajax_form_empleado_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_empleado_navigate_form(var_idempleado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empleado_navigate_form_cb);
  } // do_ajax_form_empleado_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empleado_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empleado_navigate_form_cb_after_alert);
  } // do_ajax_form_empleado_navigate_form_cb
  function do_ajax_form_empleado_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empleado_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empleado_navigate_form_cb_after_alert

  function sc_hide_form_empleado_form()
  {
  ...
  ajax_field_list[1] = "idcargo";
  ajax_field_list[2] = "nombreemp";
  ajax_field_list[3] = "apellidoemp";
  ajax_field_list[4] = "dniemp";
  ajax_field_list[5] = "fechacontratoemp";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idempleado": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcargo": {"label": "Cargo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombreemp": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apellidoemp": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dniemp": {"label": "Dni", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechacontratoemp": {"label": "Fechacontrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "idcargo": new Array(),
    "nombreemp": new Array(),
    "apellidoemp": new Array(),
    "dniemp": new Array(),
    "fechacontratoemp": new Array()
  };
  ajax_field_mult["idempleado"][1] = "idempleado";
  ajax_field_mult["idcargo"][1] = "idcargo";
  ajax_field_mult["nombreemp"][1] = "nombreemp";
  ajax_field_mult["apellidoemp"][1] = "apellidoemp";
  ajax_field_mult["dniemp"][1] = "dniemp";
  ajax_field_mult["fechacontratoemp"][1] = "fechacontratoemp";
  ...
  var ajax_field_id = {
    ...
    "nombreemp": new Array("hidden_field_label_nombreemp", "hidden_field_data_nombreemp"),
    "apellidoemp": new Array("hidden_field_label_apellidoemp", "hidden_field_data_apellidoemp"),
    "dniemp": new Array("hidden_field_label_dniemp", "hidden_field_data_dniemp"),
    "fechacontratoemp": new Array("hidden_field_label_fechacontratoemp", "hidden_field_data_fechacontratoemp")
  };
