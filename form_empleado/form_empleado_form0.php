...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_empleado_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_empleado_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_empleado_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_empleado'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_empleado'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['idempleado'] = (isset($this->nm_new_label['idempleado'])) ? $this->nm_new_label['idempleado'] : 'Id'; 
          $SC_Label_atu['idcargo'] = (isset($this->nm_new_label['idcargo'])) ? $this->nm_new_label['idcargo'] : 'Cargo'; 
          $SC_Label_atu['nombreemp'] = (isset($this->nm_new_label['nombreemp'])) ? $this->nm_new_label['nombreemp'] : 'Nombre'; 
          $SC_Label_atu['apellidoemp'] = (isset($this->nm_new_label['apellidoemp'])) ? $this->nm_new_label['apellidoemp'] : 'Apellido'; 
          $SC_Label_atu['dniemp'] = (isset($this->nm_new_label['dniemp'])) ? $this->nm_new_label['dniemp'] : 'Dni'; 
          $SC_Label_atu['fechacontratoemp'] = (isset($this->nm_new_label['fechacontratoemp'])) ? $this->nm_new_label['fechacontratoemp'] : 'Fechacontrato'; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idempleado_line" id="hidden_field_data_idempleado" style="<?php echo $sStyleHidden_idempleado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idempleado_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idempleado" class="css_idempleado_line" style="<?php echo $sStyleReadLab_idempleado; ?>"><?php echo $this->form_format_readonly("idempleado", $this->form_encode_input($this->idempleado)); ?></span><span id="id_read_off_idempleado" class="css_read_off_idempleado" style="<?php echo $sStyleReadInp_idempleado; ?>"><input type="hidden" name="idempleado" value="<?php echo $this->form_encode_input($idempleado) . "\">"?><span id="id_ajax_label_idempleado"><?php echo nl2br($idempleado); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idcargo_label" id="hidden_field_label_idcargo" style="<?php echo $sStyleHidden_idcargo; ?>"><span id="id_label_idcargo"><?php echo $this->nm_new_label['idcargo']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombreemp_label" id="hidden_field_label_nombreemp" style="<?php echo $sStyleHidden_nombreemp; ?>"><span id="id_label_nombreemp"><?php echo $this->nm_new_label['nombreemp']; ?></span></TD>
    <TD class="scFormDataOdd css_nombreemp_line" id="hidden_field_data_nombreemp" style="<?php echo $sStyleHidden_nombreemp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombreemp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_apellidoemp_label" id="hidden_field_label_apellidoemp" style="<?php echo $sStyleHidden_apellidoemp; ?>"><span id="id_label_apellidoemp"><?php echo $this->nm_new_label['apellidoemp']; ?></span></TD>
    <TD class="scFormDataOdd css_apellidoemp_line" id="hidden_field_data_apellidoemp" style="<?php echo $sStyleHidden_apellidoemp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_apellidoemp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dniemp_label" id="hidden_field_label_dniemp" style="<?php echo $sStyleHidden_dniemp; ?>"><span id="id_label_dniemp"><?php echo $this->nm_new_label['dniemp']; ?></span></TD>
    <TD class="scFormDataOdd css_dniemp_line" id="hidden_field_data_dniemp" style="<?php echo $sStyleHidden_dniemp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dniemp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechacontratoemp_label" id="hidden_field_label_fechacontratoemp" style="<?php echo $sStyleHidden_fechacontratoemp; ?>"><span id="id_label_fechacontratoemp"><?php echo $this->nm_new_label['fechacontratoemp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['php_cmp_required']['fechacontratoemp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['php_cmp_required']['fechacontratoemp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fechacontratoemp_line" id="hidden_field_data_fechacontratoemp" style="<?php echo $sStyleHidden_fechacontratoemp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechacontratoemp_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_empleado");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_empleado");
 parent.scAjaxDetailHeight("form_empleado", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_empleado']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
