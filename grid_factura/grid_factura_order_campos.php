<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_factura']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["d_iddetalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["d_iddetalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["d_iddetalle"] : "Id Detalle";
   ...
   $tab_labels["c_idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_idcliente"] : "Id Cliente";
   ...
   $tab_labels["c_nombrecli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_nombrecli"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_nombrecli"] : "Nombre Cli";
   ...
   $tab_labels["c_apellidocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_apellidocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["c_apellidocli"] : "Apellido Cli";
   ...
   $tab_labels["h_nrohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["h_nrohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["h_nrohab"] : "Nro Hab";
   ...
   $tab_labels["t_nombretipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["t_nombretipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["t_nombretipohab"] : "Nombre Tipo Hab";
   ...
   $tab_labels["t_preciotipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["t_preciotipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["t_preciotipohab"] : "Precio Tipo Hab";
   ...
   $tab_labels["r_fechares"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["r_fechares"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["r_fechares"] : "Fecha Res";
   ...
   $tab_labels["d_precioreservacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["d_precioreservacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['labels']["d_precioreservacion"] : "Precio Reservacion";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_factura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
