...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_factura"]);
   }
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_factura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_factura']['embutida_filho'] as $ind => $sc_init)
          {
