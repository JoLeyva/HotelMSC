...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_tipohabitacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_tipohabitacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tipohabitacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipohabitacion']['embutida_filho'] as $ind => $sc_init)
          {
