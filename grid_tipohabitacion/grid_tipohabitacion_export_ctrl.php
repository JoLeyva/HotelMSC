<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipohabitacion']['sc_process_barr'] = true;
require_once('../grid_tipohabitacion/index.php');
unset($_SESSION['scriptcase']['grid_tipohabitacion']['sc_process_barr']);
$ExportCtrl = new grid_tipohabitacion_export_control;
$ExportCtrl->Export_barr();

class grid_tipohabitacion_export_control
{
