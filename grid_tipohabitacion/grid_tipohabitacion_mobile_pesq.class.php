...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idtipohab";$Nm_numeric[] = "nrocamas";$Nm_numeric[] = "preciotipohab";$Nm_numeric[] = "idtipohab";$Nm_numeric[] = "nrocamas";$Nm_numeric[] = "preciotipohab";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idtipohab_cond" name="idtipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtipohab'), this, 'idtipohab')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombretipohab_cond" name="nombretipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombretipohab'), this, 'nombretipohab')">
      ...
      <br><span id="id_hide_nombretipohab"  <?php echo $str_hide_nombretipohab?>><?php
      if ($nombretipohab != "")
      {
      $nombretipohab_look = substr($this->Db->qstr($nombretipohab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_descripciontipohab_cond" name="descripciontipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_descripciontipohab'), this, 'descripciontipohab')">
      ...
      <br><span id="id_hide_descripciontipohab"  <?php echo $str_hide_descripciontipohab?>><?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nrocamas_cond" name="nrocamas_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrocamas'), this, 'nrocamas')">
      ...
      <br><span id="id_hide_nrocamas"  <?php echo $str_hide_nrocamas?>><INPUT  type="text" id="SC_nrocamas" name="nrocamas" value="<?php echo NM_encode_input($nrocamas) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
