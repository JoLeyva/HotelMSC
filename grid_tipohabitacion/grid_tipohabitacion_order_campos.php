...
<?php
   ...
   $Ord_Cmp = new grid_tipohabitacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tipohabitacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idtipohab'] = "idTipoHab";
   $tab_labels["idtipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["idtipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["idtipohab"] : "Id";
   $tab_ger_campos['nombretipohab'] = "on";
   $tab_def_campos['nombretipohab'] = "nombreTipoHab";
   $tab_labels["nombretipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["nombretipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["nombretipohab"] : "Nombre";
   $tab_ger_campos['descripciontipohab'] = "on";
   $tab_def_campos['descripciontipohab'] = "descripcionTipoHab";
   $tab_labels["descripciontipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["descripciontipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["descripciontipohab"] : "Descripcion";
   $tab_ger_campos['nrocamas'] = "on";
   $tab_def_campos['nrocamas'] = "nroCamas";
   $tab_labels["nrocamas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["nrocamas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["nrocamas"] : "Nro Camas";
   $tab_ger_campos['preciotipohab'] = "on";
   $tab_def_campos['preciotipohab'] = "precioTipoHab";
   $tab_labels["preciotipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["preciotipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['labels']["preciotipohab"] : "Precio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tipohabitacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tipohabitacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
