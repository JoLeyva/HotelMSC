...
class grid_tipohabitacion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tipohabitacion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tipohabitacion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tipohabitacion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombretipohab')
      {
          $nombretipohab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombretipohab($nombretipohab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_descripciontipohab')
      {
          $descripciontipohab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_descripciontipohab($descripciontipohab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Listado de Tipos de Habitacion</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tipohabitacion/grid_tipohabitacion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tipohabitacion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tipohabitacion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tipohabitacion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tipohabitacion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tipohabitacion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idtipohab_cond#NMF#' + search_get_sel_txt('SC_idtipohab_cond') + '@NMF@';
  str_out += 'SC_idtipohab#NMF#' + search_get_text('SC_idtipohab') + '@NMF@';
  str_out += 'SC_nombretipohab_cond#NMF#' + search_get_sel_txt('SC_nombretipohab_cond') + '@NMF@';
  str_out += 'SC_nombretipohab#NMF#' + search_get_text('SC_nombretipohab') + '@NMF@';
  str_out += 'id_ac_nombretipohab#NMF#' + search_get_text('id_ac_nombretipohab') + '@NMF@';
  str_out += 'SC_descripciontipohab_cond#NMF#' + search_get_sel_txt('SC_descripciontipohab_cond') + '@NMF@';
  str_out += 'SC_descripciontipohab#NMF#' + search_get_text('SC_descripciontipohab') + '@NMF@';
  str_out += 'id_ac_descripciontipohab#NMF#' + search_get_text('id_ac_descripciontipohab') + '@NMF@';
  str_out += 'SC_nrocamas_cond#NMF#' + search_get_sel_txt('SC_nrocamas_cond') + '@NMF@';
  str_out += 'SC_nrocamas#NMF#' + search_get_text('SC_nrocamas') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nombretipohab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombretipohab").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombretipohab",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nombretipohab").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombretipohab").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_descripciontipohab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_descripciontipohab").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_descripciontipohab",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_descripciontipohab").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_descripciontipohab").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Listado de Tipos de Habitacion</div>
...
<?php
   ...
   {
      global 
             $idtipohab_cond, $idtipohab,
             $nombretipohab_cond, $nombretipohab, $nombretipohab_autocomp,
             $descripciontipohab_cond, $descripciontipohab, $descripciontipohab_autocomp,
             $nrocamas_cond, $nrocamas,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idtipohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['idtipohab']; 
          $idtipohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['idtipohab_cond']; 
          $nombretipohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nombretipohab']; 
          $nombretipohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nombretipohab_cond']; 
          $descripciontipohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['descripciontipohab']; 
          $descripciontipohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['descripciontipohab_cond']; 
          $nrocamas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nrocamas']; 
          $nrocamas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nrocamas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['NM_operador']; 
          if (strtoupper($idtipohab_cond) != "II" && strtoupper($idtipohab_cond) != "QP" && strtoupper($idtipohab_cond) != "NP" && strtoupper($idtipohab_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idtipohab, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($nrocamas_cond) != "II" && strtoupper($nrocamas_cond) != "QP" && strtoupper($nrocamas_cond) != "NP" && strtoupper($nrocamas_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($nrocamas, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($idtipohab_cond) || empty($idtipohab_cond))
      {
         $idtipohab_cond = "gt";
      }
      if (!isset($nombretipohab_cond) || empty($nombretipohab_cond))
      {
         $nombretipohab_cond = "qp";
      }
      if (!isset($descripciontipohab_cond) || empty($descripciontipohab_cond))
      {
         $descripciontipohab_cond = "qp";
      }
      if (!isset($nrocamas_cond) || empty($nrocamas_cond))
      {
         $nrocamas_cond = "gt";
      }
      ...
      $str_hide_idtipohab = (in_array($idtipohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombretipohab = (in_array($nombretipohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descripciontipohab = (in_array($descripciontipohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nrocamas = (in_array($nrocamas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idtipohab) || $idtipohab == "")
      {
          $idtipohab = "";
      }
      if (isset($idtipohab) && !empty($idtipohab))
      {
         $tmp_pos = strpos($idtipohab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idtipohab = substr($idtipohab, 0, $tmp_pos);
         }
      }
      if (!isset($nombretipohab) || $nombretipohab == "")
      {
          $nombretipohab = "";
      }
      if (isset($nombretipohab) && !empty($nombretipohab))
      {
         $tmp_pos = strpos($nombretipohab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombretipohab = substr($nombretipohab, 0, $tmp_pos);
         }
      }
      if (!isset($descripciontipohab) || $descripciontipohab == "")
      {
          $descripciontipohab = "";
      }
      if (isset($descripciontipohab) && !empty($descripciontipohab))
      {
         $tmp_pos = strpos($descripciontipohab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $descripciontipohab = substr($descripciontipohab, 0, $tmp_pos);
         }
      }
      if (!isset($nrocamas) || $nrocamas == "")
      {
          $nrocamas = "";
      }
      if (isset($nrocamas) && !empty($nrocamas))
      {
         $tmp_pos = strpos($nrocamas, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nrocamas = substr($nrocamas, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idtipohab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idtipohab'])) ? $this->New_label['idtipohab'] : "Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idtipohab_cond" name="idtipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtipohab'), this, 'idtipohab')">
       <OPTION value="gt" <?php if ("gt" == $idtipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idtipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idtipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idtipohab" <?php echo $str_hide_idtipohab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idtipohab'])) ? $this->New_label['idtipohab'] : "Id";
 $nmgp_tab_label .= "idtipohab?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_idtipohab" name="idtipohab" value="<?php echo NM_encode_input($idtipohab) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nombretipohab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombretipohab'])) ? $this->New_label['nombretipohab'] : "Nombre"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nombretipohab_cond" name="nombretipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombretipohab'), this, 'nombretipohab')">
       <OPTION value="qp" <?php if ("qp" == $nombretipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombretipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombretipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombretipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombretipohab" <?php echo $str_hide_nombretipohab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nombretipohab'])) ? $this->New_label['nombretipohab'] : "Nombre";
 $nmgp_tab_label .= "nombretipohab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nombretipohab;
      }
?>
<INPUT  type="text" id="SC_nombretipohab" name="nombretipohab" value="<?php echo NM_encode_input($nombretipohab) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombretipohab" name="nombretipohab_autocomp" size="40"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_descripciontipohab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['descripciontipohab'])) ? $this->New_label['descripciontipohab'] : "Descripcion"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_descripciontipohab_cond" name="descripciontipohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_descripciontipohab'), this, 'descripciontipohab')">
       <OPTION value="qp" <?php if ("qp" == $descripciontipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $descripciontipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $descripciontipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $descripciontipohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_descripciontipohab" <?php echo $str_hide_descripciontipohab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['descripciontipohab'])) ? $this->New_label['descripciontipohab'] : "Descripcion";
 $nmgp_tab_label .= "descripciontipohab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $descripciontipohab;
      }
?>
<INPUT  type="text" id="SC_descripciontipohab" name="descripciontipohab" value="<?php echo NM_encode_input($descripciontipohab) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_descripciontipohab" name="descripciontipohab_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nrocamas_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nrocamas'])) ? $this->New_label['nrocamas'] : "Nro Camas"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nrocamas_cond" name="nrocamas_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrocamas'), this, 'nrocamas')">
       <OPTION value="gt" <?php if ("gt" == $nrocamas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $nrocamas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nrocamas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nrocamas" <?php echo $str_hide_nrocamas?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nrocamas'])) ? $this->New_label['nrocamas'] : "Nro Camas";
 $nmgp_tab_label .= "nrocamas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_nrocamas" name="nrocamas" value="<?php echo NM_encode_input($nrocamas) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tipohabitacion_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tipohabitacion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tipohabitacion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idtipohab_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idtipohab'), document.F1.idtipohab_cond, 'idtipohab');
   document.F1.idtipohab.value = "";
   document.F1.nombretipohab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombretipohab'), document.F1.nombretipohab_cond, 'nombretipohab');
   document.F1.nombretipohab.value = "";
   document.F1.nombretipohab_autocomp.value = "";
   document.F1.descripciontipohab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_descripciontipohab'), document.F1.descripciontipohab_cond, 'descripciontipohab');
   document.F1.descripciontipohab.value = "";
   document.F1.descripciontipohab_autocomp.value = "";
   document.F1.nrocamas_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_nrocamas'), document.F1.nrocamas_cond, 'nrocamas');
   document.F1.nrocamas.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idtipohab_cond'] = 'cond';
      $tp_fields['SC_idtipohab'] = 'text';
      $tp_fields['SC_nombretipohab_cond'] = 'cond';
      $tp_fields['SC_nombretipohab'] = 'text_aut';
      $tp_fields['id_ac_nombretipohab'] = 'text_aut';
      $tp_fields['SC_descripciontipohab_cond'] = 'cond';
      $tp_fields['SC_descripciontipohab'] = 'text_aut';
      $tp_fields['id_ac_descripciontipohab'] = 'text_aut';
      $tp_fields['SC_nrocamas_cond'] = 'cond';
      $tp_fields['SC_nrocamas'] = 'text';
   ...
   {
      global $idtipohab_cond, $idtipohab,
             $nombretipohab_cond, $nombretipohab, $nombretipohab_autocomp,
             $descripciontipohab_cond, $descripciontipohab, $descripciontipohab_autocomp,
             $nrocamas_cond, $nrocamas, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nombretipohab_autocomp) && empty($nombretipohab))
      {
          $nombretipohab = $nombretipohab_autocomp;
      }
      if (!empty($descripciontipohab_autocomp) && empty($descripciontipohab))
      {
          $descripciontipohab = $descripciontipohab_autocomp;
      }
      $idtipohab_cond_salva = $idtipohab_cond; 
      if (!isset($idtipohab_input_2) || $idtipohab_input_2 == "")
      {
          $idtipohab_input_2 = $idtipohab;
      }
      $nombretipohab_cond_salva = $nombretipohab_cond; 
      if (!isset($nombretipohab_input_2) || $nombretipohab_input_2 == "")
      {
          $nombretipohab_input_2 = $nombretipohab;
      }
      $descripciontipohab_cond_salva = $descripciontipohab_cond; 
      if (!isset($descripciontipohab_input_2) || $descripciontipohab_input_2 == "")
      {
          $descripciontipohab_input_2 = $descripciontipohab;
      }
      $nrocamas_cond_salva = $nrocamas_cond; 
      if (!isset($nrocamas_input_2) || $nrocamas_input_2 == "")
      {
          $nrocamas_input_2 = $nrocamas;
      }
      if ($idtipohab_cond != "in")
      {
          nm_limpa_numero($idtipohab, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($nrocamas_cond != "in")
      {
          nm_limpa_numero($nrocamas, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['idtipohab'] = $idtipohab; 
      if (is_array($idtipohab) && !empty($idtipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0] = $idtipohab;
      }
      elseif ($idtipohab_cond_salva == "nu" || $idtipohab_cond_salva == "nn" || $idtipohab_cond_salva == "ep" || $idtipohab_cond_salva == "ne" || !empty($idtipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0][0] = $idtipohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['idtipohab_cond'] = $idtipohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['cmp'] = "idtipohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['opc'] = $idtipohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq']['idtipohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nombretipohab'] = $nombretipohab; 
      if (is_array($nombretipohab) && !empty($nombretipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0] = $nombretipohab;
      }
      elseif ($nombretipohab_cond_salva == "nu" || $nombretipohab_cond_salva == "nn" || $nombretipohab_cond_salva == "ep" || $nombretipohab_cond_salva == "ne" || !empty($nombretipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0][0] = $nombretipohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nombretipohab_cond'] = $nombretipohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['cmp'] = "nombretipohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['opc'] = $nombretipohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq']['nombretipohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['descripciontipohab'] = $descripciontipohab; 
      if (is_array($descripciontipohab) && !empty($descripciontipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0] = $descripciontipohab;
      }
      elseif ($descripciontipohab_cond_salva == "nu" || $descripciontipohab_cond_salva == "nn" || $descripciontipohab_cond_salva == "ep" || $descripciontipohab_cond_salva == "ne" || !empty($descripciontipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0][0] = $descripciontipohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['descripciontipohab_cond'] = $descripciontipohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['cmp'] = "descripciontipohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['opc'] = $descripciontipohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq']['descripciontipohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nrocamas'] = $nrocamas; 
      if (is_array($nrocamas) && !empty($nrocamas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0] = $nrocamas;
      }
      elseif ($nrocamas_cond_salva == "nu" || $nrocamas_cond_salva == "nn" || $nrocamas_cond_salva == "ep" || $nrocamas_cond_salva == "ne" || !empty($nrocamas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['val'][0][0] = $nrocamas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['nrocamas_cond'] = $nrocamas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['cmp'] = "nrocamas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid]['opc'] = $nrocamas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['grid_pesq']['nrocamas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['idtipohab'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nombretipohab != '') {
      $nombretipohab_look = substr($this->Db->qstr($nombretipohab), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombretipohab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nombretipohab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombretipohab'] = $nombretipohab;
      }
      $nmgp_def_dados = array();
    if ($descripciontipohab != '') {
      $descripciontipohab_look = substr($this->Db->qstr($descripciontipohab), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['descripciontipohab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['descripciontipohab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['descripciontipohab'] = $descripciontipohab;
      }
      $Conteudo = $nrocamas;
      if (strtoupper($nrocamas_cond) != "II" && strtoupper($nrocamas_cond) != "QP" && strtoupper($nrocamas_cond) != "NP" && strtoupper($nrocamas_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['nrocamas'] = $Conteudo;

      //----- $idtipohab
      $this->Date_part = false;
      if (isset($idtipohab) || $idtipohab_cond == "nu" || $idtipohab_cond == "nn" || $idtipohab_cond == "ep" || $idtipohab_cond == "ne")
      {
         $this->monta_condicao("idTipoHab", $idtipohab_cond, $idtipohab, "", "idtipohab");
      }

      //----- $nombretipohab
      $this->Date_part = false;
      if (isset($nombretipohab) || $nombretipohab_cond == "nu" || $nombretipohab_cond == "nn" || $nombretipohab_cond == "ep" || $nombretipohab_cond == "ne")
      {
         $this->monta_condicao("nombreTipoHab", $nombretipohab_cond, $nombretipohab, "", "nombretipohab");
      }

      //----- $descripciontipohab
      $this->Date_part = false;
      if (isset($descripciontipohab) || $descripciontipohab_cond == "nu" || $descripciontipohab_cond == "nn" || $descripciontipohab_cond == "ep" || $descripciontipohab_cond == "ne")
      {
         $this->monta_condicao("descripcionTipoHab", $descripciontipohab_cond, $descripciontipohab, "", "descripciontipohab");
      }

      //----- $nrocamas
      $this->Date_part = false;
      if (isset($nrocamas) || $nrocamas_cond == "nu" || $nrocamas_cond == "nn" || $nrocamas_cond == "ep" || $nrocamas_cond == "ne")
      {
         $this->monta_condicao("nroCamas", $nrocamas_cond, $nrocamas, "", "nrocamas");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipohabitacion']['cond_pesq'] .= $this->NM_operador;
