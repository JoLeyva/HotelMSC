<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["idcliente"] : "Id Cliente";
   $tab_ger_campos['nombrecli'] = "on";
   $tab_def_campos['nombrecli'] = "nombreCli";
   $tab_labels["nombrecli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["nombrecli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["nombrecli"] : "Nombre Cli";
   $tab_ger_campos['apellidocli'] = "on";
   $tab_def_campos['apellidocli'] = "apellidoCli";
   $tab_labels["apellidocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["apellidocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["apellidocli"] : "Apellido Cli";
   $tab_ger_campos['telefonocli'] = "on";
   $tab_def_campos['telefonocli'] = "telefonoCli";
   $tab_labels["telefonocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["telefonocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["telefonocli"] : "Telefono Cli";
   $tab_ger_campos['correocli'] = "on";
   $tab_def_campos['correocli'] = "correoCli";
   $tab_labels["correocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["correocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["correocli"] : "Correo Cli";
   $tab_ger_campos['dnicli'] = "on";
   $tab_def_campos['dnicli'] = "dniCli";
   $tab_labels["dnicli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["dnicli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["dnicli"] : "Dni Cli";
