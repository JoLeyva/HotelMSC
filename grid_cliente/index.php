<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_cliente']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_conf']       = "";
...
// 
      ...
      $this->path_conf       = $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_conf'];
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_cliente']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hotel', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($usr_name)) 
          {
              ...
              nm_limpa_str_grid_cliente($_SESSION["usr_name"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cliente']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cliente']['label'] = "Listado Cliente";
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_cliente']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "idcliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "nombrecli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "apellidocli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "telefonocli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "correocli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "dnicli";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_cliente_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cliente_res_xls.class.php"); 
          } 
          $this->xls  = new grid_cliente_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cliente_res_xml.class.php"); 
          } 
          $this->xml  = new grid_cliente_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cliente_res_json.class.php"); 
          } 
          $this->json  = new grid_cliente_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cliente_res_csv.class.php"); 
          } 
          $this->csv  = new grid_cliente_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cliente_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_cliente_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_cliente/grid_cliente_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_cliente_det.class.php"); 
              } 
              $this->det  = new grid_cliente_det();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_cliente']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente'][$path_doc_md5][1] = "grid_cliente_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Hotel'])) {
               $_SESSION['scriptcase']['grid_cliente']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Hotel'];
           }
       }
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cliente']['orig_pesq'] = $nmgp_orig_pesq;
   }
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_cliente']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_cliente']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_cliente']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_cliente']['Sc_seq_det'] = $Sc_seq_det;
       } 
