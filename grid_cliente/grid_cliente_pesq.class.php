...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $dnicli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['dnicli']; 
          $dnicli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['dnicli_cond']; 
          $idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['idcliente']; 
          $idcliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['idcliente_cond']; 
          $nombrecli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['nombrecli']; 
          $nombrecli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['nombrecli_cond']; 
          $apellidocli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['apellidocli']; 
          $apellidocli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['apellidocli_cond']; 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cliente']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function trata_campos()
   {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['dnicli'] = $dnicli; 
      if (is_array($dnicli) && !empty($dnicli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0] = $dnicli;
      }
      elseif ($dnicli_cond_salva == "nu" || $dnicli_cond_salva == "nn" || $dnicli_cond_salva == "ep" || $dnicli_cond_salva == "ne" || !empty($dnicli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $dnicli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['dnicli_cond'] = $dnicli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['cmp'] = "dnicli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['opc'] = $dnicli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['grid_pesq']['dnicli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['idcliente'] = $idcliente; 
      if (is_array($idcliente) && !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0] = $idcliente;
      }
      elseif ($idcliente_cond_salva == "nu" || $idcliente_cond_salva == "nn" || $idcliente_cond_salva == "ep" || $idcliente_cond_salva == "ne" || !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $idcliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['idcliente_cond'] = $idcliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['cmp'] = "idcliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['opc'] = $idcliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['grid_pesq']['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['nombrecli'] = $nombrecli; 
      if (is_array($nombrecli) && !empty($nombrecli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0] = $nombrecli;
      }
      elseif ($nombrecli_cond_salva == "nu" || $nombrecli_cond_salva == "nn" || $nombrecli_cond_salva == "ep" || $nombrecli_cond_salva == "ne" || !empty($nombrecli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $nombrecli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['nombrecli_cond'] = $nombrecli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['cmp'] = "nombrecli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['opc'] = $nombrecli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['grid_pesq']['nombrecli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['apellidocli'] = $apellidocli; 
      if (is_array($apellidocli) && !empty($apellidocli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0] = $apellidocli;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $apellidocli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['campos_busca']['apellidocli_cond'] = $apellidocli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['cmp'] = "apellidocli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid]['opc'] = $apellidocli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['grid_pesq']['apellidocli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
