  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tarjeta_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idtarjeta
  function do_ajax_form_tarjeta_mob_validate_idtarjeta()
  {
    var nomeCampo_idtarjeta = "idtarjeta";
    var var_idtarjeta = scAjaxGetFieldHidden(nomeCampo_idtarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarjeta_mob_validate_idtarjeta(var_idtarjeta, var_script_case_init, do_ajax_form_tarjeta_mob_validate_idtarjeta_cb);
  } // do_ajax_form_tarjeta_mob_validate_idtarjeta

  function do_ajax_form_tarjeta_mob_validate_idtarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtarjeta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarjeta_mob_validate_idtarjeta_cb

  // ---------- Validate idcliente
  function do_ajax_form_tarjeta_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarjeta_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_tarjeta_mob_validate_idcliente_cb);
  } // do_ajax_form_tarjeta_mob_validate_idcliente

  function do_ajax_form_tarjeta_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarjeta_mob_validate_idcliente_cb

  // ---------- Validate nrotarjeta
  function do_ajax_form_tarjeta_mob_validate_nrotarjeta()
  {
    var nomeCampo_nrotarjeta = "nrotarjeta";
    var var_nrotarjeta = scAjaxGetFieldText(nomeCampo_nrotarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarjeta_mob_validate_nrotarjeta(var_nrotarjeta, var_script_case_init, do_ajax_form_tarjeta_mob_validate_nrotarjeta_cb);
  } // do_ajax_form_tarjeta_mob_validate_nrotarjeta

  function do_ajax_form_tarjeta_mob_validate_nrotarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nrotarjeta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarjeta_mob_validate_nrotarjeta_cb

  // ---------- Validate vencimientotarjeta
  function do_ajax_form_tarjeta_mob_validate_vencimientotarjeta()
  {
    var nomeCampo_vencimientotarjeta = "vencimientotarjeta";
    var var_vencimientotarjeta = scAjaxGetFieldText(nomeCampo_vencimientotarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_vencimientotarjeta = scAjaxGetFieldText(nomeCampo_vencimientotarjeta);
      x_ajax_form_tarjeta_mob_validate_vencimientotarjeta(var_vencimientotarjeta, var_script_case_init, do_ajax_form_tarjeta_mob_validate_vencimientotarjeta_cb);
    }, 200);
  } // do_ajax_form_tarjeta_mob_validate_vencimientotarjeta

  function do_ajax_form_tarjeta_mob_validate_vencimientotarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vencimientotarjeta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarjeta_mob_validate_vencimientotarjeta_cb

  // ---------- Validate codigoseguridad
  function do_ajax_form_tarjeta_mob_validate_codigoseguridad()
  {
    var nomeCampo_codigoseguridad = "codigoseguridad";
    var var_codigoseguridad = scAjaxGetFieldText(nomeCampo_codigoseguridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarjeta_mob_validate_codigoseguridad(var_codigoseguridad, var_script_case_init, do_ajax_form_tarjeta_mob_validate_codigoseguridad_cb);
  } // do_ajax_form_tarjeta_mob_validate_codigoseguridad

  function do_ajax_form_tarjeta_mob_validate_codigoseguridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigoseguridad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarjeta_mob_validate_codigoseguridad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tarjeta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tarjeta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtarjeta = scAjaxGetFieldHidden("idtarjeta");
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_nrotarjeta = scAjaxGetFieldText("nrotarjeta");
    var var_vencimientotarjeta = scAjaxGetFieldText("vencimientotarjeta");
    var var_codigoseguridad = scAjaxGetFieldText("codigoseguridad");
    ...
    scAjaxProcOn();
    x_ajax_form_tarjeta_mob_submit_form(var_idtarjeta, var_idcliente, var_nrotarjeta, var_vencimientotarjeta, var_codigoseguridad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tarjeta_mob_submit_form_cb);
  } // do_ajax_form_tarjeta_mob_submit_form

  function do_ajax_form_tarjeta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtarjeta");
      scAjaxHideErrorDisplay("idcliente");
      scAjaxHideErrorDisplay("nrotarjeta");
      scAjaxHideErrorDisplay("vencimientotarjeta");
      scAjaxHideErrorDisplay("codigoseguridad");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tarjeta_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tarjeta_mob_submit_form_cb
  function do_ajax_form_tarjeta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tarjeta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tarjeta_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tarjeta_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tarjeta_mob_navigate_form();
    }
  }

  function perform_ajax_form_tarjeta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("vencimientotarjeta");
    scAjaxHideErrorDisplay("codigoseguridad");
    var var_idtarjeta = document.F2.idtarjeta.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tarjeta_mob_navigate_form(var_idtarjeta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tarjeta_mob_navigate_form_cb);
  } // do_ajax_form_tarjeta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarjeta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tarjeta_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtarjeta.value = scAjaxGetKeyValue("idtarjeta");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tarjeta_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tarjeta_mob_navigate_form_cb
  function do_ajax_form_tarjeta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tarjeta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tarjeta_mob_navigate_form_cb_after_alert

  function sc_hide_form_tarjeta_mob_form()
  {
  ...
  ajax_field_list[0] = "idtarjeta";
  ajax_field_list[1] = "idcliente";
  ajax_field_list[2] = "nrotarjeta";
  ajax_field_list[3] = "vencimientotarjeta";
  ajax_field_list[4] = "codigoseguridad";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idtarjeta": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "nrotarjeta": {"label": "Nro Tarjeta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vencimientotarjeta": {"label": "Vencimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigoseguridad": {"label": "Codigo Seguridad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "vencimientotarjeta": new Array(),
    "codigoseguridad": new Array()
  };
  ajax_field_mult["idtarjeta"][1] = "idtarjeta";
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["nrotarjeta"][1] = "nrotarjeta";
  ajax_field_mult["vencimientotarjeta"][1] = "vencimientotarjeta";
  ajax_field_mult["codigoseguridad"][1] = "codigoseguridad";

  var ajax_field_id = {
    "idtarjeta": new Array("hidden_field_label_idtarjeta", "hidden_field_data_idtarjeta"),
    "idcliente": new Array("hidden_field_label_idcliente", "hidden_field_data_idcliente"),
    "nrotarjeta": new Array("hidden_field_label_nrotarjeta", "hidden_field_data_nrotarjeta"),
    "vencimientotarjeta": new Array("hidden_field_label_vencimientotarjeta", "hidden_field_data_vencimientotarjeta"),
    "codigoseguridad": new Array("hidden_field_label_codigoseguridad", "hidden_field_data_codigoseguridad")
  };
