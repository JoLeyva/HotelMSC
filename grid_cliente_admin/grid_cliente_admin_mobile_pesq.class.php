...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcliente";$Nm_numeric[] = "idcliente";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dnicli_cond" name="dnicli_cond" onChange="nm_campos_between(document.getElementById('id_vis_dnicli'), this, 'dnicli')">
      ...
      <br><span id="id_hide_dnicli"  <?php echo $str_hide_dnicli?>><?php
      if ($dnicli != "")
      {
      $dnicli_look = substr($this->Db->qstr($dnicli), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_idcliente"  <?php echo $str_hide_idcliente?>><INPUT  type="text" id="SC_idcliente" name="idcliente" value="<?php echo NM_encode_input($idcliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombrecli_cond" name="nombrecli_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombrecli'), this, 'nombrecli')">
      ...
      <br><span id="id_hide_nombrecli"  <?php echo $str_hide_nombrecli?>><?php
      if ($nombrecli != "")
      {
      $nombrecli_look = substr($this->Db->qstr($nombrecli), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_apellidocli_cond" name="apellidocli_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellidocli'), this, 'apellidocli')">
      ...
      <br><span id="id_hide_apellidocli"  <?php echo $str_hide_apellidocli?>><?php
      if ($apellidocli != "")
      {
      $apellidocli_look = substr($this->Db->qstr($apellidocli), 1, -1); 
      $nmgp_def_dados = array(); 
