<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cliente_admin']['sc_process_barr'] = true;
require_once('../grid_cliente_admin/index.php');
unset($_SESSION['scriptcase']['grid_cliente_admin']['sc_process_barr']);
$ExportCtrl = new grid_cliente_admin_export_control;
$ExportCtrl->Export_barr();

class grid_cliente_admin_export_control
{
