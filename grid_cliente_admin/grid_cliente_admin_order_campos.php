...
<?php
   ...
   $Ord_Cmp = new grid_cliente_admin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cliente_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["idcliente"] : "Id Cliente";
   $tab_ger_campos['nombrecli'] = "on";
   $tab_def_campos['nombrecli'] = "nombreCli";
   $tab_labels["nombrecli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["nombrecli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["nombrecli"] : "Nombre Cli";
   $tab_ger_campos['apellidocli'] = "on";
   $tab_def_campos['apellidocli'] = "apellidoCli";
   $tab_labels["apellidocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["apellidocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["apellidocli"] : "Apellido Cli";
   $tab_ger_campos['telefonocli'] = "on";
   $tab_def_campos['telefonocli'] = "telefonoCli";
   $tab_labels["telefonocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["telefonocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["telefonocli"] : "Telefono Cli";
   $tab_ger_campos['correocli'] = "on";
   $tab_def_campos['correocli'] = "correoCli";
   $tab_labels["correocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["correocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["correocli"] : "Correo Cli";
   $tab_ger_campos['dnicli'] = "on";
   $tab_def_campos['dnicli'] = "dniCli";
   $tab_labels["dnicli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["dnicli"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['labels']["dnicli"] : "Dni Cli";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cliente_admin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cliente_admin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
