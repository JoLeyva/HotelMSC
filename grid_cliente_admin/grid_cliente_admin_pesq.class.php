...
class grid_cliente_admin_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cliente_admin_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cliente_admin_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cliente_admin_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dnicli')
      {
          $dnicli = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dnicli($dnicli);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombrecli')
      {
          $nombrecli = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombrecli($nombrecli);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_apellidocli')
      {
          $apellidocli = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_apellidocli($apellidocli);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cliente_admin/grid_cliente_admin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cliente_admin_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cliente_admin_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cliente_admin_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cliente_admin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cliente_admin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_dnicli_cond#NMF#' + search_get_sel_txt('SC_dnicli_cond') + '@NMF@';
  str_out += 'SC_dnicli#NMF#' + search_get_text('SC_dnicli') + '@NMF@';
  str_out += 'id_ac_dnicli#NMF#' + search_get_text('id_ac_dnicli') + '@NMF@';
  ...
  str_out += 'SC_nombrecli_cond#NMF#' + search_get_sel_txt('SC_nombrecli_cond') + '@NMF@';
  str_out += 'SC_nombrecli#NMF#' + search_get_text('SC_nombrecli') + '@NMF@';
  str_out += 'id_ac_nombrecli#NMF#' + search_get_text('id_ac_nombrecli') + '@NMF@';
  str_out += 'SC_apellidocli_cond#NMF#' + search_get_sel_txt('SC_apellidocli_cond') + '@NMF@';
  str_out += 'SC_apellidocli#NMF#' + search_get_text('SC_apellidocli') + '@NMF@';
  str_out += 'id_ac_apellidocli#NMF#' + search_get_text('id_ac_apellidocli') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nombrecli").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombrecli").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombrecli",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nombrecli").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombrecli").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_apellidocli").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_apellidocli").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_apellidocli",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_apellidocli").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_apellidocli").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_dnicli").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_dnicli").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dnicli",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Listado Cliente</div>
...
<?php
   ...
   {
      global 
             $dnicli_cond, $dnicli, $dnicli_autocomp,
             $idcliente_cond, $idcliente,
             $nombrecli_cond, $nombrecli, $nombrecli_autocomp,
             $apellidocli_cond, $apellidocli, $apellidocli_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $dnicli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['dnicli']; 
          $dnicli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['dnicli_cond']; 
          $idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['idcliente']; 
          $idcliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['idcliente_cond']; 
          $nombrecli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['nombrecli']; 
          $nombrecli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['nombrecli_cond']; 
          $apellidocli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['apellidocli']; 
          $apellidocli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['apellidocli_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['NM_operador']; 
          if (strtoupper($idcliente_cond) != "II" && strtoupper($idcliente_cond) != "QP" && strtoupper($idcliente_cond) != "NP" && strtoupper($idcliente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($dnicli_cond) || empty($dnicli_cond))
      {
         $dnicli_cond = "qp";
      }
      ...
      if (!isset($nombrecli_cond) || empty($nombrecli_cond))
      {
         $nombrecli_cond = "qp";
      }
      if (!isset($apellidocli_cond) || empty($apellidocli_cond))
      {
         $apellidocli_cond = "qp";
      }
      ...
      $str_hide_dnicli = (in_array($dnicli_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idcliente = (in_array($idcliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombrecli = (in_array($nombrecli_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_apellidocli = (in_array($apellidocli_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($dnicli) || $dnicli == "")
      {
          $dnicli = "";
      }
      if (isset($dnicli) && !empty($dnicli))
      {
         $tmp_pos = strpos($dnicli, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dnicli = substr($dnicli, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nombrecli) || $nombrecli == "")
      {
          $nombrecli = "";
      }
      if (isset($nombrecli) && !empty($nombrecli))
      {
         $tmp_pos = strpos($nombrecli, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombrecli = substr($nombrecli, 0, $tmp_pos);
         }
      }
      if (!isset($apellidocli) || $apellidocli == "")
      {
          $apellidocli = "";
      }
      if (isset($apellidocli) && !empty($apellidocli))
      {
         $tmp_pos = strpos($apellidocli, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $apellidocli = substr($apellidocli, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_dnicli_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dnicli'])) ? $this->New_label['dnicli'] : "Dni Cli"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dnicli_cond" name="dnicli_cond" onChange="nm_campos_between(document.getElementById('id_vis_dnicli'), this, 'dnicli')">
       <OPTION value="qp" <?php if ("qp" == $dnicli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dnicli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dnicli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dnicli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dnicli" <?php echo $str_hide_dnicli?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dnicli'])) ? $this->New_label['dnicli'] : "Dni Cli";
 $nmgp_tab_label .= "dnicli?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $dnicli;
      }
?>
<INPUT  type="text" id="SC_dnicli" name="dnicli" value="<?php echo NM_encode_input($dnicli) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dnicli" name="dnicli_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idcliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idcliente'])) ? $this->New_label['idcliente'] : "Id Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idcliente_cond" name="idcliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcliente'), this, 'idcliente')">
       <OPTION value="gt" <?php if ("gt" == $idcliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
...
?>
<INPUT  type="text" id="SC_idcliente" name="idcliente" value="<?php echo NM_encode_input($idcliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nombrecli_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombrecli'])) ? $this->New_label['nombrecli'] : "Nombre Cli"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombrecli_cond" name="nombrecli_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombrecli'), this, 'nombrecli')">
       <OPTION value="qp" <?php if ("qp" == $nombrecli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombrecli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombrecli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombrecli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombrecli" <?php echo $str_hide_nombrecli?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombrecli'])) ? $this->New_label['nombrecli'] : "Nombre Cli";
 $nmgp_tab_label .= "nombrecli?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nombrecli;
      }
?>
<INPUT  type="text" id="SC_nombrecli" name="nombrecli" value="<?php echo NM_encode_input($nombrecli) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombrecli" name="nombrecli_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_apellidocli_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['apellidocli'])) ? $this->New_label['apellidocli'] : "Apellido Cli"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_apellidocli_cond" name="apellidocli_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellidocli'), this, 'apellidocli')">
       <OPTION value="qp" <?php if ("qp" == $apellidocli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $apellidocli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $apellidocli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $apellidocli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apellidocli" <?php echo $str_hide_apellidocli?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['apellidocli'])) ? $this->New_label['apellidocli'] : "Apellido Cli";
 $nmgp_tab_label .= "apellidocli?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $apellidocli;
      }
?>
<INPUT  type="text" id="SC_apellidocli" name="apellidocli" value="<?php echo NM_encode_input($apellidocli) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_apellidocli" name="apellidocli_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_cliente_admin_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cliente_admin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cliente_admin']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.dnicli_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_dnicli'), document.F1.dnicli_cond, 'dnicli');
   document.F1.dnicli.value = "";
   document.F1.dnicli_autocomp.value = "";
   document.F1.idcliente_cond.value = 'gt';
   ...
   document.F1.nombrecli_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombrecli'), document.F1.nombrecli_cond, 'nombrecli');
   document.F1.nombrecli.value = "";
   document.F1.nombrecli_autocomp.value = "";
   document.F1.apellidocli_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_apellidocli'), document.F1.apellidocli_cond, 'apellidocli');
   document.F1.apellidocli.value = "";
   document.F1.apellidocli_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_dnicli_cond'] = 'cond';
      $tp_fields['SC_dnicli'] = 'text_aut';
      $tp_fields['id_ac_dnicli'] = 'text_aut';
      $tp_fields['SC_idcliente_cond'] = 'cond';
      $tp_fields['SC_idcliente'] = 'text';
      $tp_fields['SC_nombrecli_cond'] = 'cond';
      $tp_fields['SC_nombrecli'] = 'text_aut';
      $tp_fields['id_ac_nombrecli'] = 'text_aut';
      $tp_fields['SC_apellidocli_cond'] = 'cond';
      $tp_fields['SC_apellidocli'] = 'text_aut';
      $tp_fields['id_ac_apellidocli'] = 'text_aut';
   ...
   {
      global $dnicli_cond, $dnicli, $dnicli_autocomp,
             $idcliente_cond, $idcliente,
             $nombrecli_cond, $nombrecli, $nombrecli_autocomp,
             $apellidocli_cond, $apellidocli, $apellidocli_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($dnicli_autocomp) && empty($dnicli))
      {
          $dnicli = $dnicli_autocomp;
      }
      if (!empty($nombrecli_autocomp) && empty($nombrecli))
      {
          $nombrecli = $nombrecli_autocomp;
      }
      if (!empty($apellidocli_autocomp) && empty($apellidocli))
      {
          $apellidocli = $apellidocli_autocomp;
      }
      $dnicli_cond_salva = $dnicli_cond; 
      if (!isset($dnicli_input_2) || $dnicli_input_2 == "")
      {
          $dnicli_input_2 = $dnicli;
      }
      ...
      $nombrecli_cond_salva = $nombrecli_cond; 
      if (!isset($nombrecli_input_2) || $nombrecli_input_2 == "")
      {
          $nombrecli_input_2 = $nombrecli;
      }
      $apellidocli_cond_salva = $apellidocli_cond; 
      if (!isset($apellidocli_input_2) || $apellidocli_input_2 == "")
      {
          $apellidocli_input_2 = $apellidocli;
      }
      if ($idcliente_cond != "in")
      {
          nm_limpa_numero($idcliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['dnicli'] = $dnicli; 
      if (is_array($dnicli) && !empty($dnicli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0] = $dnicli;
      }
      elseif ($dnicli_cond_salva == "nu" || $dnicli_cond_salva == "nn" || $dnicli_cond_salva == "ep" || $dnicli_cond_salva == "ne" || !empty($dnicli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0][0] = $dnicli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['dnicli_cond'] = $dnicli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['cmp'] = "dnicli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['opc'] = $dnicli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq']['dnicli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['idcliente'] = $idcliente; 
      if (is_array($idcliente) && !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0] = $idcliente;
      }
      elseif ($idcliente_cond_salva == "nu" || $idcliente_cond_salva == "nn" || $idcliente_cond_salva == "ep" || $idcliente_cond_salva == "ne" || !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0][0] = $idcliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['idcliente_cond'] = $idcliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['cmp'] = "idcliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['opc'] = $idcliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq']['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['nombrecli'] = $nombrecli; 
      if (is_array($nombrecli) && !empty($nombrecli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0] = $nombrecli;
      }
      elseif ($nombrecli_cond_salva == "nu" || $nombrecli_cond_salva == "nn" || $nombrecli_cond_salva == "ep" || $nombrecli_cond_salva == "ne" || !empty($nombrecli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0][0] = $nombrecli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['nombrecli_cond'] = $nombrecli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['cmp'] = "nombrecli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['opc'] = $nombrecli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq']['nombrecli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['apellidocli'] = $apellidocli; 
      if (is_array($apellidocli) && !empty($apellidocli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0] = $apellidocli;
      }
      elseif ($apellidocli_cond_salva == "nu" || $apellidocli_cond_salva == "nn" || $apellidocli_cond_salva == "ep" || $apellidocli_cond_salva == "ne" || !empty($apellidocli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['val'][0][0] = $apellidocli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['apellidocli_cond'] = $apellidocli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['cmp'] = "apellidocli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid]['opc'] = $apellidocli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['grid_pesq']['apellidocli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($dnicli != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dnicli'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['dnicli'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dnicli'] = $dnicli;
      }
      $Conteudo = $idcliente;
      if (strtoupper($idcliente_cond) != "II" && strtoupper($idcliente_cond) != "QP" && strtoupper($idcliente_cond) != "NP" && strtoupper($idcliente_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idcliente'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nombrecli != '') {
      $nombrecli_look = substr($this->Db->qstr($nombrecli), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombrecli'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombrecli'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombrecli'] = $nombrecli;
      }
      $nmgp_def_dados = array();
    if ($apellidocli != '') {
      $apellidocli_look = substr($this->Db->qstr($apellidocli), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['apellidocli'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['apellidocli'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['apellidocli'] = $apellidocli;
      }

      //----- $dnicli
      $this->Date_part = false;
      if (isset($dnicli) || $dnicli_cond == "nu" || $dnicli_cond == "nn" || $dnicli_cond == "ep" || $dnicli_cond == "ne")
      {
         $this->monta_condicao("dniCli", $dnicli_cond, $dnicli, "", "dnicli");
      }
      ...
      //----- $nombrecli
      $this->Date_part = false;
      if (isset($nombrecli) || $nombrecli_cond == "nu" || $nombrecli_cond == "nn" || $nombrecli_cond == "ep" || $nombrecli_cond == "ne")
      {
         $this->monta_condicao("nombreCli", $nombrecli_cond, $nombrecli, "", "nombrecli");
      }

      //----- $apellidocli
      $this->Date_part = false;
      if (isset($apellidocli) || $apellidocli_cond == "nu" || $apellidocli_cond == "nn" || $apellidocli_cond == "ep" || $apellidocli_cond == "ne")
      {
         $this->monta_condicao("apellidoCli", $apellidocli_cond, $apellidocli, "", "apellidocli");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_admin']['cond_pesq'] .= $this->NM_operador;
