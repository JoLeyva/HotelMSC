<?php
@session_start() ;
$_SESSION['scriptcase']['grid_factura_admin']['sc_process_barr'] = true;
require_once('../grid_factura_admin/index.php');
unset($_SESSION['scriptcase']['grid_factura_admin']['sc_process_barr']);
$ExportCtrl = new grid_factura_admin_export_control;
$ExportCtrl->Export_barr();

class grid_factura_admin_export_control
{
