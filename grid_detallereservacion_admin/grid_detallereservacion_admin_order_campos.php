<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detallereservacion_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detallereservacion_admin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallereservacion_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["d_iddetalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["d_iddetalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["d_iddetalle"] : "Id Detalle";
   ...
   $tab_labels["c_apellidocli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["c_apellidocli"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["c_apellidocli"] : "Apellido Cli";
   ...
   $tab_labels["h_nrohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["h_nrohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["h_nrohab"] : "Nro Hab";
   ...
   $tab_labels["t_nombretipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["t_nombretipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["t_nombretipohab"] : "Nombre Tipo Hab";
   ...
   $tab_labels["t_preciotipohab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["t_preciotipohab"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["t_preciotipohab"] : "Precio Tipo Hab";
   ...
   $tab_labels["r_fechares"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["r_fechares"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["r_fechares"] : "Fecha Res";
   ...
   $tab_labels["d_precioreservacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["d_precioreservacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['labels']["d_precioreservacion"] : "Precio Reservacion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallereservacion_admin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallereservacion_admin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
