...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_detallereservacion_admin"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_detallereservacion_admin"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallereservacion_admin</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallereservacion_admin']['embutida_filho'] as $ind => $sc_init)
          {
