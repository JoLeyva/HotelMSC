...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "r.fechaRes";$Nm_datas[] = "r_fechaRes";$Nm_datas[] = "r.fechaLlegada";$Nm_datas[] = "r_fechaLlegada";$Nm_numeric[] = "d_iddetalle";$Nm_numeric[] = "r_idreservacion";$Nm_numeric[] = "c_idcliente";$Nm_numeric[] = "t_preciotipohab";$Nm_numeric[] = "d_precioreservacion";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_d_iddetalle_cond" name="d_iddetalle_cond" onChange="nm_campos_between(document.getElementById('id_vis_d_iddetalle'), this, 'd_iddetalle')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_r_idreservacion_cond" name="r_idreservacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_r_idreservacion'), this, 'r_idreservacion')">
      ...
      <br><span id="id_hide_r_idreservacion"  <?php echo $str_hide_r_idreservacion?>><INPUT  type="text" id="SC_r_idreservacion" name="r_idreservacion" value="<?php echo NM_encode_input($r_idreservacion) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_c_apellidocli_cond" name="c_apellidocli_cond" onChange="nm_campos_between(document.getElementById('id_vis_c_apellidocli'), this, 'c_apellidocli')">
      ...
      <br><span id="id_hide_c_apellidocli"  <?php echo $str_hide_c_apellidocli?>><?php
      if ($c_apellidocli != "")
      {
      $c_apellidocli_look = substr($this->Db->qstr($c_apellidocli), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_h_nrohab_cond" name="h_nrohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_h_nrohab'), this, 'h_nrohab')">
      ...
      <br><span id="id_hide_h_nrohab"  <?php echo $str_hide_h_nrohab?>><?php
      if ($h_nrohab != "")
      {
      $h_nrohab_look = substr($this->Db->qstr($h_nrohab), 1, -1); 
      $nmgp_def_dados = array(); 
