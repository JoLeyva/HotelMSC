...
//
   ...
   $_SESSION['scriptcase']['pdf_report_admin']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['d_iddetalle'] = "Id Detalle";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['c_idcliente'] = "Id Cliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['c_nombrecli'] = "Nombre Cli";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['c_apellidocli'] = "Apellido Cli";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['h_nrohab'] = "Nro Hab";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['t_nombretipohab'] = "Nombre Tipo Hab";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['t_preciotipohab'] = "Precio Tipo Hab";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['r_fechares'] = "Fecha Res";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['d_precioreservacion'] = "Precio Reservacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['cantidad'] = "cantidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['impuesto'] = "impuesto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['subtotal'] = "subtotal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['total'] = "total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['labels']['total1'] = "total1";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_report_admin']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_report_admin']['qt_col_grid']) 
      {  
          ...
          $this->total1[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->total1[$this->nm_grid_colunas]);
            $cell_d_idDetalle = array('posx' => '43', 'posy' => '144.1360041666485', 'data' => $this->d_iddetalle[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '255', 'color_g'    => '255', 'color_b'    => '255', 'font_style' => $this->default_style);
            $cell_c_idCliente = array('posx' => '166.42291666664568', 'posy' => '65.50501249999174', 'data' => $this->c_idcliente[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_c_nombreCli = array('posx' => '154.45475416664718', 'posy' => '28.409635416663086', 'data' => $this->c_nombrecli[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_c_apellidoCli = array('posx' => '170', 'posy' => '28.355924999996425', 'data' => $this->c_apellidocli[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_t_nombreTipoHab = array('posx' => '112.1253895833192', 'posy' => '119.26517083331831', 'data' => $this->t_nombretipohab[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_t_precioTipoHab = array('posx' => '166', 'posy' => '119', 'data' => $this->t_preciotipohab[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_r_fechaRes = array('posx' => '32.7464208333292', 'posy' => '149.84518333331445', 'data' => $this->r_fechares[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '255', 'color_g'    => '255', 'color_b'    => '255', 'font_style' => $this->default_style);
            $cell_d_precioReservacion = array('posx' => '182', 'posy' => '119.62897291665159', 'data' => $this->t_preciotipohab[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cantidad = array('posx' => '85.1958333333226', 'posy' => '120.12083333331819', 'data' => $this->SC_conv_utf8('1'), 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_subtotal = array('posx' => '182', 'posy' => '253.99999999996797', 'data' => $this->t_preciotipohab[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_impuesto = array('posx' => '182', 'posy' => '262.73124999996685', 'data' => $this->SC_conv_utf8('0'), 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_total = array('posx' => '182.0333333333104', 'posy' => '283.66508333329756', 'data' => $this->t_preciotipohab[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
