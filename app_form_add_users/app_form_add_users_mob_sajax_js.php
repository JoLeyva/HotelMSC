...
?>
  ...
  // ---------- Validate active
  function do_ajax_app_form_add_users_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldCheckbox(nomeCampo_active, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_active(var_active, var_script_case_init, do_ajax_app_form_add_users_mob_validate_active_cb);
  } // do_ajax_app_form_add_users_mob_validate_active

  function do_ajax_app_form_add_users_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_active_cb

  // ---------- Validate groups
  function do_ajax_app_form_add_users_mob_validate_groups()
  {
    var nomeCampo_groups = "groups";
    var var_groups = scAjaxGetFieldCheckbox(nomeCampo_groups, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_groups(var_groups, var_script_case_init, do_ajax_app_form_add_users_mob_validate_groups_cb);
  } // do_ajax_app_form_add_users_mob_validate_groups

  function do_ajax_app_form_add_users_mob_validate_groups_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "groups";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_groups_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_add_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_mob_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_mob_submit_form_cb);
...
?>
  ...
  var ajax_error_list = {
    ...
    "active": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
