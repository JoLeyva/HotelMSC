      ...
      if ($this->groups != "")
      {
          if (is_array($this->groups))
          {
              ...
              foreach ($this->groups_1 as $ind => $dados_groups_1 ) 
              {
                  ...
                  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups']) && !in_array($dados_groups_1, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups']))
                  {
                      $hasError = true;
...
$aLookup[] = array(app_form_add_users_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_add_users_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_active'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['active']['valList'][$i] = app_form_add_users_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(app_form_add_users_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', app_form_add_users_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['Lookup_groups'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php 
   ...
   ob_end_clean();
          ...
          {
              $this->NM_ajax_info['fldList']['groups']['valList'][$i] = app_form_add_users_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
