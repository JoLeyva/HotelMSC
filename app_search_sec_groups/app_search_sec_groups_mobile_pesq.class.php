...
class app_search_sec_groups_pesq
{
   ...
   function monta_busca()
   {
      ...
      $this->Ini->Str_btn_filter = "scriptcase9_Rhino/scriptcase9_Rhino" . $_SESSION['scriptcase']['reg_conf']['css_dir'] . ".php";
      $this->Str_btn_filter_css  = "scriptcase9_Rhino/scriptcase9_Rhino.css";
