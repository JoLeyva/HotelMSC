...
class grid_tarjeta_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tarjeta_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tarjeta_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tarjeta_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigoseguridad')
      {
          $codigoseguridad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigoseguridad($codigoseguridad);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nrotarjeta')
      {
          $nrotarjeta = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nrotarjeta($nrotarjeta);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "vencimientoTarjeta";$Nm_datas[] = "vencimientoTarjeta";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tarjeta/grid_tarjeta_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tarjeta_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tarjeta_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tarjeta_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tarjeta']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tarjeta']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_codigoseguridad_cond#NMF#' + search_get_sel_txt('SC_codigoseguridad_cond') + '@NMF@';
  str_out += 'SC_codigoseguridad#NMF#' + search_get_text('SC_codigoseguridad') + '@NMF@';
  str_out += 'id_ac_codigoseguridad#NMF#' + search_get_text('id_ac_codigoseguridad') + '@NMF@';
  str_out += 'SC_idtarjeta_cond#NMF#' + search_get_sel_txt('SC_idtarjeta_cond') + '@NMF@';
  str_out += 'SC_idtarjeta#NMF#' + search_get_text('SC_idtarjeta') + '@NMF@';
  ...
  str_out += 'SC_nrotarjeta_cond#NMF#' + search_get_sel_txt('SC_nrotarjeta_cond') + '@NMF@';
  str_out += 'SC_nrotarjeta#NMF#' + search_get_text('SC_nrotarjeta') + '@NMF@';
  str_out += 'id_ac_nrotarjeta#NMF#' + search_get_text('id_ac_nrotarjeta') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nrotarjeta").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nrotarjeta").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nrotarjeta",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nrotarjeta").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nrotarjeta").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_codigoseguridad").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codigoseguridad").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigoseguridad",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_codigoseguridad").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codigoseguridad").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Listado de Tarjetas</div>
...
<?php
   ...
   {
      global 
             $codigoseguridad_cond, $codigoseguridad, $codigoseguridad_autocomp,
             $idtarjeta_cond, $idtarjeta,
             $idcliente_cond, $idcliente,
             $nrotarjeta_cond, $nrotarjeta, $nrotarjeta_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $codigoseguridad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['codigoseguridad']; 
          $codigoseguridad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['codigoseguridad_cond']; 
          $idtarjeta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idtarjeta']; 
          $idtarjeta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idtarjeta_cond']; 
          $idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idcliente']; 
          $idcliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idcliente_cond']; 
          $nrotarjeta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['nrotarjeta']; 
          $nrotarjeta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['nrotarjeta_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['NM_operador']; 
          if (strtoupper($idtarjeta_cond) != "II" && strtoupper($idtarjeta_cond) != "QP" && strtoupper($idtarjeta_cond) != "NP" && strtoupper($idtarjeta_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idtarjeta, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      ...
      if (!isset($codigoseguridad_cond) || empty($codigoseguridad_cond))
      {
         $codigoseguridad_cond = "qp";
      }
      if (!isset($idtarjeta_cond) || empty($idtarjeta_cond))
      {
         $idtarjeta_cond = "gt";
      }
      ...
      if (!isset($nrotarjeta_cond) || empty($nrotarjeta_cond))
      {
         $nrotarjeta_cond = "qp";
      }
      ...
      $str_hide_codigoseguridad = (in_array($codigoseguridad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idtarjeta = (in_array($idtarjeta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idcliente = (in_array($idcliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nrotarjeta = (in_array($nrotarjeta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($codigoseguridad) || $codigoseguridad == "")
      {
          $codigoseguridad = "";
      }
      if (isset($codigoseguridad) && !empty($codigoseguridad))
      {
         $tmp_pos = strpos($codigoseguridad, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigoseguridad = substr($codigoseguridad, 0, $tmp_pos);
         }
      }
      if (!isset($idtarjeta) || $idtarjeta == "")
      {
          $idtarjeta = "";
      }
      if (isset($idtarjeta) && !empty($idtarjeta))
      {
         $tmp_pos = strpos($idtarjeta, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idtarjeta = substr($idtarjeta, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nrotarjeta) || $nrotarjeta == "")
      {
          $nrotarjeta = "";
      }
      if (isset($nrotarjeta) && !empty($nrotarjeta))
      {
         $tmp_pos = strpos($nrotarjeta, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nrotarjeta = substr($nrotarjeta, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigoseguridad_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigoseguridad'])) ? $this->New_label['codigoseguridad'] : "Codigo Seguridad"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigoseguridad_cond" name="codigoseguridad_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoseguridad'), this, 'codigoseguridad')">
       <OPTION value="qp" <?php if ("qp" == $codigoseguridad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigoseguridad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigoseguridad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigoseguridad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigoseguridad" <?php echo $str_hide_codigoseguridad?> valign="top">
 ...
 $nmgp_tab_label .= "codigoseguridad?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $codigoseguridad;
      }
?>
<INPUT  type="text" id="SC_codigoseguridad" name="codigoseguridad" value="<?php echo NM_encode_input($codigoseguridad) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigoseguridad" name="codigoseguridad_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idtarjeta_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idtarjeta'])) ? $this->New_label['idtarjeta'] : "Id"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idtarjeta_cond" name="idtarjeta_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtarjeta'), this, 'idtarjeta')">
       <OPTION value="gt" <?php if ("gt" == $idtarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idtarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idtarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idtarjeta" <?php echo $str_hide_idtarjeta?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idtarjeta'])) ? $this->New_label['idtarjeta'] : "Id";
 $nmgp_tab_label .= "idtarjeta?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idtarjeta" name="idtarjeta" value="<?php echo NM_encode_input($idtarjeta) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idcliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcliente'])) ? $this->New_label['idcliente'] : "Apellido Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<INPUT  type="text" id="SC_idcliente" name="idcliente" value="<?php echo NM_encode_input($idcliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nrotarjeta_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nrotarjeta'])) ? $this->New_label['nrotarjeta'] : "Nro Tarjeta"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nrotarjeta_cond" name="nrotarjeta_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrotarjeta'), this, 'nrotarjeta')">
       <OPTION value="qp" <?php if ("qp" == $nrotarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nrotarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nrotarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nrotarjeta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nrotarjeta" <?php echo $str_hide_nrotarjeta?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nrotarjeta'])) ? $this->New_label['nrotarjeta'] : "Nro Tarjeta";
 $nmgp_tab_label .= "nrotarjeta?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nrotarjeta;
      }
?>
<INPUT  type="text" id="SC_nrotarjeta" name="nrotarjeta" value="<?php echo NM_encode_input($nrotarjeta) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nrotarjeta" name="nrotarjeta_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tarjeta_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tarjeta']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tarjeta']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.codigoseguridad_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codigoseguridad'), document.F1.codigoseguridad_cond, 'codigoseguridad');
   document.F1.codigoseguridad.value = "";
   document.F1.codigoseguridad_autocomp.value = "";
   document.F1.idtarjeta_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idtarjeta'), document.F1.idtarjeta_cond, 'idtarjeta');
   document.F1.idtarjeta.value = "";
   ...
   document.F1.nrotarjeta_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nrotarjeta'), document.F1.nrotarjeta_cond, 'nrotarjeta');
   document.F1.nrotarjeta.value = "";
   document.F1.nrotarjeta_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_codigoseguridad_cond'] = 'cond';
      $tp_fields['SC_codigoseguridad'] = 'text_aut';
      $tp_fields['id_ac_codigoseguridad'] = 'text_aut';
      $tp_fields['SC_idtarjeta_cond'] = 'cond';
      $tp_fields['SC_idtarjeta'] = 'text';
      $tp_fields['SC_idcliente_cond'] = 'cond';
      $tp_fields['SC_idcliente'] = 'text';
      $tp_fields['SC_nrotarjeta_cond'] = 'cond';
      $tp_fields['SC_nrotarjeta'] = 'text_aut';
      $tp_fields['id_ac_nrotarjeta'] = 'text_aut';
   ...
   {
      global $codigoseguridad_cond, $codigoseguridad, $codigoseguridad_autocomp,
             $idtarjeta_cond, $idtarjeta,
             $idcliente_cond, $idcliente,
             $nrotarjeta_cond, $nrotarjeta, $nrotarjeta_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($codigoseguridad_autocomp) && empty($codigoseguridad))
      {
          $codigoseguridad = $codigoseguridad_autocomp;
      }
      if (!empty($nrotarjeta_autocomp) && empty($nrotarjeta))
      {
          $nrotarjeta = $nrotarjeta_autocomp;
      }
      $codigoseguridad_cond_salva = $codigoseguridad_cond; 
      if (!isset($codigoseguridad_input_2) || $codigoseguridad_input_2 == "")
      {
          $codigoseguridad_input_2 = $codigoseguridad;
      }
      $idtarjeta_cond_salva = $idtarjeta_cond; 
      if (!isset($idtarjeta_input_2) || $idtarjeta_input_2 == "")
      {
          $idtarjeta_input_2 = $idtarjeta;
      }
      ...
      $nrotarjeta_cond_salva = $nrotarjeta_cond; 
      if (!isset($nrotarjeta_input_2) || $nrotarjeta_input_2 == "")
      {
          $nrotarjeta_input_2 = $nrotarjeta;
      }
      if ($idtarjeta_cond != "in")
      {
          nm_limpa_numero($idtarjeta, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['codigoseguridad'] = $codigoseguridad; 
      if (is_array($codigoseguridad) && !empty($codigoseguridad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0] = $codigoseguridad;
      }
      elseif ($codigoseguridad_cond_salva == "nu" || $codigoseguridad_cond_salva == "nn" || $codigoseguridad_cond_salva == "ep" || $codigoseguridad_cond_salva == "ne" || !empty($codigoseguridad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0][0] = $codigoseguridad;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['codigoseguridad_cond'] = $codigoseguridad_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['cmp'] = "codigoseguridad"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['opc'] = $codigoseguridad_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq']['codigoseguridad'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idtarjeta'] = $idtarjeta; 
      if (is_array($idtarjeta) && !empty($idtarjeta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0] = $idtarjeta;
      }
      elseif ($idtarjeta_cond_salva == "nu" || $idtarjeta_cond_salva == "nn" || $idtarjeta_cond_salva == "ep" || $idtarjeta_cond_salva == "ne" || !empty($idtarjeta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0][0] = $idtarjeta;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idtarjeta_cond'] = $idtarjeta_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['cmp'] = "idtarjeta"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['opc'] = $idtarjeta_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq']['idtarjeta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idcliente'] = $idcliente; 
      if (is_array($idcliente) && !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0] = $idcliente;
      }
      elseif ($idcliente_cond_salva == "nu" || $idcliente_cond_salva == "nn" || $idcliente_cond_salva == "ep" || $idcliente_cond_salva == "ne" || !empty($idcliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0][0] = $idcliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['idcliente_cond'] = $idcliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['cmp'] = "idcliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['opc'] = $idcliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq']['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['nrotarjeta'] = $nrotarjeta; 
      if (is_array($nrotarjeta) && !empty($nrotarjeta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0] = $nrotarjeta;
      }
      elseif ($nrotarjeta_cond_salva == "nu" || $nrotarjeta_cond_salva == "nn" || $nrotarjeta_cond_salva == "ep" || $nrotarjeta_cond_salva == "ne" || !empty($nrotarjeta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['val'][0][0] = $nrotarjeta;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['nrotarjeta_cond'] = $nrotarjeta_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['cmp'] = "nrotarjeta"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid]['opc'] = $nrotarjeta_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['grid_pesq']['nrotarjeta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($codigoseguridad != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigoseguridad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['codigoseguridad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigoseguridad'] = $codigoseguridad;
      }
      $Conteudo = $idtarjeta;
      if (strtoupper($idtarjeta_cond) != "II" && strtoupper($idtarjeta_cond) != "QP" && strtoupper($idtarjeta_cond) != "NP" && strtoupper($idtarjeta_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idtarjeta'] = $Conteudo;
      $Conteudo = $idcliente;
      if (strtoupper($idcliente_cond) != "II" && strtoupper($idcliente_cond) != "QP" && strtoupper($idcliente_cond) != "NP" && strtoupper($idcliente_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
    ...
    if ($nrotarjeta != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nrotarjeta'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nrotarjeta'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nrotarjeta'] = $nrotarjeta;
      }

      //----- $codigoseguridad
      $this->Date_part = false;
      if (isset($codigoseguridad) || $codigoseguridad_cond == "nu" || $codigoseguridad_cond == "nn" || $codigoseguridad_cond == "ep" || $codigoseguridad_cond == "ne")
      {
         $this->monta_condicao("codigoSeguridad", $codigoseguridad_cond, $codigoseguridad, "", "codigoseguridad");
      }

      //----- $idtarjeta
      $this->Date_part = false;
      if (isset($idtarjeta) || $idtarjeta_cond == "nu" || $idtarjeta_cond == "nn" || $idtarjeta_cond == "ep" || $idtarjeta_cond == "ne")
      {
         $this->monta_condicao("idTarjeta", $idtarjeta_cond, $idtarjeta, "", "idtarjeta");
      }
      ...
      //----- $nrotarjeta
      $this->Date_part = false;
      if (isset($nrotarjeta) || $nrotarjeta_cond == "nu" || $nrotarjeta_cond == "nn" || $nrotarjeta_cond == "ep" || $nrotarjeta_cond == "ne")
      {
         $this->monta_condicao("nroTarjeta", $nrotarjeta_cond, $nrotarjeta, "", "nrotarjeta");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjeta']['cond_pesq'] .= $this->NM_operador;
