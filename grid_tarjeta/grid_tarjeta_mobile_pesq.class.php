...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "vencimientoTarjeta";$Nm_datas[] = "vencimientoTarjeta";$Nm_numeric[] = "idtarjeta";$Nm_numeric[] = "idcliente";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigoseguridad_cond" name="codigoseguridad_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoseguridad'), this, 'codigoseguridad')">
      ...
      <br><span id="id_hide_codigoseguridad"  <?php echo $str_hide_codigoseguridad?>><?php
      if ($codigoseguridad != "")
      {
      $codigoseguridad_look = substr($this->Db->qstr($codigoseguridad), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idtarjeta_cond" name="idtarjeta_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtarjeta'), this, 'idtarjeta')">
      ...
      <br><span id="id_hide_idtarjeta"  <?php echo $str_hide_idtarjeta?>><INPUT  type="text" id="SC_idtarjeta" name="idtarjeta" value="<?php echo NM_encode_input($idtarjeta) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nrotarjeta_cond" name="nrotarjeta_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrotarjeta'), this, 'nrotarjeta')">
      ...
      <br><span id="id_hide_nrotarjeta"  <?php echo $str_hide_nrotarjeta?>><?php
      if ($nrotarjeta != "")
      {
      $nrotarjeta_look = substr($this->Db->qstr($nrotarjeta), 1, -1); 
      $nmgp_def_dados = array(); 
