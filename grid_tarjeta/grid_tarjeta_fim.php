...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_tarjeta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_tarjeta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tarjeta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tarjeta']['embutida_filho'] as $ind => $sc_init)
          {
