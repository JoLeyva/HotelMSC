...
<?php
   ...
   $Ord_Cmp = new grid_tarjeta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tarjeta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idtarjeta'] = "idTarjeta";
   $tab_labels["idtarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["idtarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["idtarjeta"] : "Id";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idCliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["idcliente"] : "Apellido Cliente";
   $tab_ger_campos['nrotarjeta'] = "on";
   $tab_def_campos['nrotarjeta'] = "nroTarjeta";
   $tab_labels["nrotarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["nrotarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["nrotarjeta"] : "Nro Tarjeta";
   $tab_ger_campos['vencimientotarjeta'] = "on";
   $tab_def_campos['vencimientotarjeta'] = "vencimientoTarjeta";
   $tab_labels["vencimientotarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["vencimientotarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["vencimientotarjeta"] : "Vencimiento";
   $tab_ger_campos['codigoseguridad'] = "on";
   $tab_def_campos['codigoseguridad'] = "codigoSeguridad";
   $tab_labels["codigoseguridad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["codigoseguridad"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['labels']["codigoseguridad"] : "Codigo Seguridad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tarjeta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tarjeta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
