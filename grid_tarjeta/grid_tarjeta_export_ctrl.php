<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarjeta']['sc_process_barr'] = true;
require_once('../grid_tarjeta/index.php');
unset($_SESSION['scriptcase']['grid_tarjeta']['sc_process_barr']);
$ExportCtrl = new grid_tarjeta_export_control;
$ExportCtrl->Export_barr();

class grid_tarjeta_export_control
{
