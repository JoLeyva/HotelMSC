...
<?php
   ...
   $Ord_Cmp = new grid_empleado_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_empleado_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idempleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["idempleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["idempleado"] : "Id";
   $tab_ger_campos['idcargo'] = "on";
   $tab_def_campos['idcargo'] = "idCargo";
   $tab_labels["idcargo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["idcargo"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["idcargo"] : "Cargo";
   $tab_ger_campos['nombreemp'] = "on";
   $tab_def_campos['nombreemp'] = "nombreEmp";
   $tab_labels["nombreemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["nombreemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["nombreemp"] : "Nombre";
   $tab_ger_campos['apellidoemp'] = "on";
   $tab_def_campos['apellidoemp'] = "apellidoEmp";
   $tab_labels["apellidoemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["apellidoemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["apellidoemp"] : "Apellido";
   $tab_ger_campos['dniemp'] = "on";
   $tab_def_campos['dniemp'] = "dniEmp";
   $tab_labels["dniemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["dniemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["dniemp"] : "Dni";
   $tab_ger_campos['fechacontratoemp'] = "on";
   $tab_def_campos['fechacontratoemp'] = "fechacontratoEmp";
   $tab_labels["fechacontratoemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["fechacontratoemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['labels']["fechacontratoemp"] : "Fechacontrato";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_empleado']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_empleado']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_empleado_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_empleado']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
