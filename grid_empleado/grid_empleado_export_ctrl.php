<?php
@session_start() ;
$_SESSION['scriptcase']['grid_empleado']['sc_process_barr'] = true;
require_once('../grid_empleado/index.php');
unset($_SESSION['scriptcase']['grid_empleado']['sc_process_barr']);
$ExportCtrl = new grid_empleado_export_control;
$ExportCtrl->Export_barr();

class grid_empleado_export_control
{
