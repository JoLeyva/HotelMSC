<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallereservacion']['sc_process_barr'] = true;
require_once('../grid_detallereservacion/index.php');
unset($_SESSION['scriptcase']['grid_detallereservacion']['sc_process_barr']);
$ExportCtrl = new grid_detallereservacion_export_control;
$ExportCtrl->Export_barr();

class grid_detallereservacion_export_control
{
