<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reservacion']['sc_process_barr'] = true;
require_once('../grid_reservacion/index.php');
unset($_SESSION['scriptcase']['grid_reservacion']['sc_process_barr']);
$ExportCtrl = new grid_reservacion_export_control;
$ExportCtrl->Export_barr();

class grid_reservacion_export_control
{
