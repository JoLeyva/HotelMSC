...
<?php
   ...
   $Ord_Cmp = new grid_reservacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reservacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idreservacion'] = "idReservacion";
   $tab_labels["idreservacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idreservacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idreservacion"] : "Id Reservacion";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idCliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idcliente"] : "Cliente";
   $tab_ger_campos['idempleado'] = "on";
   $tab_def_campos['idempleado'] = "idEmpleado";
   $tab_labels["idempleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idempleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["idempleado"] : "Empleado";
   $tab_ger_campos['fechares'] = "on";
   $tab_def_campos['fechares'] = "fechaRes";
   $tab_labels["fechares"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["fechares"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["fechares"] : "Fecha Reservacion";
   $tab_ger_campos['fechallegada'] = "on";
   $tab_def_campos['fechallegada'] = "fechaLLegada";
   $tab_labels["fechallegada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["fechallegada"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["fechallegada"] : "Fecha Llegada";
   $tab_ger_campos['nrodiasres'] = "on";
   $tab_def_campos['nrodiasres'] = "nroDiasRes";
   $tab_labels["nrodiasres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["nrodiasres"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["nrodiasres"] : "Días Reservados";
   $tab_ger_campos['nropersonasres'] = "on";
   $tab_def_campos['nropersonasres'] = "nroPersonasRes";
   $tab_labels["nropersonasres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["nropersonasres"])) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['labels']["nropersonasres"] : "Cantidad de Personas";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reservacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reservacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reservacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reservacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
