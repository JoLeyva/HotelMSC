...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_reservacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_reservacion"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_reservacion'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reservacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reservacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reservacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reservacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reservacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reservacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reservacion']['embutida_filho'] as $ind => $sc_init)
          {
