...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaRes";$Nm_datas[] = "fechaRes";$Nm_datas[] = "fechaLLegada";$Nm_datas[] = "fechaLLegada";$Nm_numeric[] = "idreservacion";$Nm_numeric[] = "idcliente";$Nm_numeric[] = "idempleado";$Nm_numeric[] = "nrodiasres";$Nm_numeric[] = "nropersonasres";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nropersonasres_cond" name="nropersonasres_cond" onChange="nm_campos_between(document.getElementById('id_vis_nropersonasres'), this, 'nropersonasres')">
      ...
      <br><span id="id_hide_nropersonasres"  <?php echo $str_hide_nropersonasres?>><INPUT  type="text" id="SC_nropersonasres" name="nropersonasres" value="<?php echo NM_encode_input($nropersonasres) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idreservacion_cond" name="idreservacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_idreservacion'), this, 'idreservacion')">
      ...
      <br><span id="id_hide_idreservacion"  <?php echo $str_hide_idreservacion?>><INPUT  type="text" id="SC_idreservacion" name="idreservacion" value="<?php echo NM_encode_input($idreservacion) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
