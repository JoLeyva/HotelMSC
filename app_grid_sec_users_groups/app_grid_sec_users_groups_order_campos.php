<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hotel.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['perfil'] = "perfil";
   }
   else
   {
       $tab_def_campos['perfil'] = "SELECT nombreCargo 
FROM cargo 
WHERE idCargo = '{perfil}' 
ORDER BY nombreCargo";
   }
   $tab_labels["perfil"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["perfil"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["perfil"] : "Perfil";
   $tab_ger_campos['perfil'] = "none";
