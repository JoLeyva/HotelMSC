...
class grid_habitacion_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_habitacion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_habitacion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_habitacion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nrohab')
      {
          $nrohab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nrohab($nrohab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_habitacion/grid_habitacion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_habitacion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_habitacion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_habitacion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_habitacion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_habitacion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idhabitacion_cond#NMF#' + search_get_sel_txt('SC_idhabitacion_cond') + '@NMF@';
  str_out += 'SC_idhabitacion#NMF#' + search_get_text('SC_idhabitacion') + '@NMF@';
  str_out += 'SC_nrohab_cond#NMF#' + search_get_sel_txt('SC_nrohab_cond') + '@NMF@';
  str_out += 'SC_nrohab#NMF#' + search_get_text('SC_nrohab') + '@NMF@';
  str_out += 'id_ac_nrohab#NMF#' + search_get_text('id_ac_nrohab') + '@NMF@';
  ...
  str_out += 'SC_estadohab_cond#NMF#' + search_get_sel_txt('SC_estadohab_cond') + '@NMF@';
  str_out += 'SC_estadohab#NMF#' + search_get_text('SC_estadohab') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nrohab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nrohab").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nrohab",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Listado de Habitaciones</div>
...
<?php
   ...
   {
      global 
             $idhabitacion_cond, $idhabitacion,
             $nrohab_cond, $nrohab, $nrohab_autocomp,
             $idtipohab_cond, $idtipohab,
             $estadohab_cond, $estadohab,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idhabitacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idhabitacion']; 
          $idhabitacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idhabitacion_cond']; 
          $nrohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['nrohab']; 
          $nrohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['nrohab_cond']; 
          $idtipohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idtipohab']; 
          $idtipohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idtipohab_cond']; 
          $estadohab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['estadohab']; 
          $estadohab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['estadohab_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['NM_operador']; 
          if (strtoupper($idhabitacion_cond) != "II" && strtoupper($idhabitacion_cond) != "QP" && strtoupper($idhabitacion_cond) != "NP" && strtoupper($idhabitacion_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idhabitacion, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          ...
          if (strtoupper($estadohab_cond) != "II" && strtoupper($estadohab_cond) != "QP" && strtoupper($estadohab_cond) != "NP" && strtoupper($estadohab_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($estadohab, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($idhabitacion_cond) || empty($idhabitacion_cond))
      {
         $idhabitacion_cond = "gt";
      }
      if (!isset($nrohab_cond) || empty($nrohab_cond))
      {
         $nrohab_cond = "qp";
      }
      ...
      if (!isset($estadohab_cond) || empty($estadohab_cond))
      {
         $estadohab_cond = "gt";
      }
      ...
      $str_hide_idhabitacion = (in_array($idhabitacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nrohab = (in_array($nrohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idtipohab = (in_array($idtipohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_estadohab = (in_array($estadohab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idhabitacion) || $idhabitacion == "")
      {
          $idhabitacion = "";
      }
      if (isset($idhabitacion) && !empty($idhabitacion))
      {
         $tmp_pos = strpos($idhabitacion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idhabitacion = substr($idhabitacion, 0, $tmp_pos);
         }
      }
      if (!isset($nrohab) || $nrohab == "")
      {
          $nrohab = "";
      }
      if (isset($nrohab) && !empty($nrohab))
      {
         $tmp_pos = strpos($nrohab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nrohab = substr($nrohab, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($estadohab) || $estadohab == "")
      {
          $estadohab = "";
      }
      if (isset($estadohab) && !empty($estadohab))
      {
         $tmp_pos = strpos($estadohab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $estadohab = substr($estadohab, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idhabitacion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idhabitacion'])) ? $this->New_label['idhabitacion'] : "Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idhabitacion_cond" name="idhabitacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_idhabitacion'), this, 'idhabitacion')">
       <OPTION value="gt" <?php if ("gt" == $idhabitacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idhabitacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idhabitacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idhabitacion" <?php echo $str_hide_idhabitacion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idhabitacion'])) ? $this->New_label['idhabitacion'] : "Id";
 $nmgp_tab_label .= "idhabitacion?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_idhabitacion" name="idhabitacion" value="<?php echo NM_encode_input($idhabitacion) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nrohab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nrohab'])) ? $this->New_label['nrohab'] : "Numero"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nrohab_cond" name="nrohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrohab'), this, 'nrohab')">
       <OPTION value="qp" <?php if ("qp" == $nrohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nrohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nrohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nrohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nrohab" <?php echo $str_hide_nrohab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nrohab'])) ? $this->New_label['nrohab'] : "Numero";
 $nmgp_tab_label .= "nrohab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nrohab;
      }
?>
<INPUT  type="text" id="SC_nrohab" name="nrohab" value="<?php echo NM_encode_input($nrohab) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nrohab" name="nrohab_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idtipohab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idtipohab'])) ? $this->New_label['idtipohab'] : "Tipo de Habitación"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_idtipohab" name="idtipohab" value="<?php echo NM_encode_input($idtipohab) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_estadohab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['estadohab'])) ? $this->New_label['estadohab'] : "Estado"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_estadohab_cond" name="estadohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_estadohab'), this, 'estadohab')">
       <OPTION value="gt" <?php if ("gt" == $estadohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $estadohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $estadohab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_estadohab" <?php echo $str_hide_estadohab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['estadohab'])) ? $this->New_label['estadohab'] : "Estado";
 $nmgp_tab_label .= "estadohab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_estadohab" name="estadohab" value="<?php echo NM_encode_input($estadohab) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_habitacion_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_habitacion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_habitacion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idhabitacion_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idhabitacion'), document.F1.idhabitacion_cond, 'idhabitacion');
   document.F1.idhabitacion.value = "";
   document.F1.nrohab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nrohab'), document.F1.nrohab_cond, 'nrohab');
   document.F1.nrohab.value = "";
   document.F1.nrohab_autocomp.value = "";
   ...
   document.F1.estadohab_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_estadohab'), document.F1.estadohab_cond, 'estadohab');
   document.F1.estadohab.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idhabitacion_cond'] = 'cond';
      $tp_fields['SC_idhabitacion'] = 'text';
      $tp_fields['SC_nrohab_cond'] = 'cond';
      $tp_fields['SC_nrohab'] = 'text_aut';
      $tp_fields['id_ac_nrohab'] = 'text_aut';
      $tp_fields['SC_idtipohab_cond'] = 'cond';
      $tp_fields['SC_idtipohab'] = 'text';
      $tp_fields['SC_estadohab_cond'] = 'cond';
      $tp_fields['SC_estadohab'] = 'text';
   ...
   {
      global $idhabitacion_cond, $idhabitacion,
             $nrohab_cond, $nrohab, $nrohab_autocomp,
             $idtipohab_cond, $idtipohab,
             $estadohab_cond, $estadohab, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nrohab_autocomp) && empty($nrohab))
      {
          $nrohab = $nrohab_autocomp;
      }
      $idhabitacion_cond_salva = $idhabitacion_cond; 
      if (!isset($idhabitacion_input_2) || $idhabitacion_input_2 == "")
      {
          $idhabitacion_input_2 = $idhabitacion;
      }
      $nrohab_cond_salva = $nrohab_cond; 
      if (!isset($nrohab_input_2) || $nrohab_input_2 == "")
      {
          $nrohab_input_2 = $nrohab;
      }
      ...
      $estadohab_cond_salva = $estadohab_cond; 
      if (!isset($estadohab_input_2) || $estadohab_input_2 == "")
      {
          $estadohab_input_2 = $estadohab;
      }
      if ($idhabitacion_cond != "in")
      {
          nm_limpa_numero($idhabitacion, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idtipohab_cond != "in")
      {
          nm_limpa_numero($idtipohab, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($estadohab_cond != "in")
      {
          nm_limpa_numero($estadohab, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idhabitacion'] = $idhabitacion; 
      if (is_array($idhabitacion) && !empty($idhabitacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0] = $idhabitacion;
      }
      elseif ($idhabitacion_cond_salva == "nu" || $idhabitacion_cond_salva == "nn" || $idhabitacion_cond_salva == "ep" || $idhabitacion_cond_salva == "ne" || !empty($idhabitacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0][0] = $idhabitacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idhabitacion_cond'] = $idhabitacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['cmp'] = "idhabitacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['opc'] = $idhabitacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq']['idhabitacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['nrohab'] = $nrohab; 
      if (is_array($nrohab) && !empty($nrohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0] = $nrohab;
      }
      elseif ($nrohab_cond_salva == "nu" || $nrohab_cond_salva == "nn" || $nrohab_cond_salva == "ep" || $nrohab_cond_salva == "ne" || !empty($nrohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0][0] = $nrohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['nrohab_cond'] = $nrohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['cmp'] = "nrohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['opc'] = $nrohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq']['nrohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idtipohab'] = $idtipohab; 
      if (is_array($idtipohab) && !empty($idtipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0] = $idtipohab;
      }
      elseif ($idtipohab_cond_salva == "nu" || $idtipohab_cond_salva == "nn" || $idtipohab_cond_salva == "ep" || $idtipohab_cond_salva == "ne" || !empty($idtipohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0][0] = $idtipohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['idtipohab_cond'] = $idtipohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['cmp'] = "idtipohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['opc'] = $idtipohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq']['idtipohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['estadohab'] = $estadohab; 
      if (is_array($estadohab) && !empty($estadohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0] = $estadohab;
      }
      elseif ($estadohab_cond_salva == "nu" || $estadohab_cond_salva == "nn" || $estadohab_cond_salva == "ep" || $estadohab_cond_salva == "ne" || !empty($estadohab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['val'][0][0] = $estadohab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['estadohab_cond'] = $estadohab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['cmp'] = "estadohab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid]['opc'] = $estadohab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['grid_pesq']['estadohab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $idhabitacion;
      if (strtoupper($idhabitacion_cond) != "II" && strtoupper($idhabitacion_cond) != "QP" && strtoupper($idhabitacion_cond) != "NP" && strtoupper($idhabitacion_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idhabitacion'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nrohab != '') {
      $nrohab_look = substr($this->Db->qstr($nrohab), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nrohab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nrohab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nrohab'] = $nrohab;
      }
      $Conteudo = $idtipohab;
      if (strtoupper($idtipohab_cond) != "II" && strtoupper($idtipohab_cond) != "QP" && strtoupper($idtipohab_cond) != "NP" && strtoupper($idtipohab_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['estadohab'] = $Conteudo;

      //----- $idhabitacion
      $this->Date_part = false;
      if (isset($idhabitacion) || $idhabitacion_cond == "nu" || $idhabitacion_cond == "nn" || $idhabitacion_cond == "ep" || $idhabitacion_cond == "ne")
      {
         $this->monta_condicao("idHabitacion", $idhabitacion_cond, $idhabitacion, "", "idhabitacion");
      }

      //----- $nrohab
      $this->Date_part = false;
      if (isset($nrohab) || $nrohab_cond == "nu" || $nrohab_cond == "nn" || $nrohab_cond == "ep" || $nrohab_cond == "ne")
      {
         $this->monta_condicao("nroHab", $nrohab_cond, $nrohab, "", "nrohab");
      }
      ...
      //----- $estadohab
      $this->Date_part = false;
      if (isset($estadohab) || $estadohab_cond == "nu" || $estadohab_cond == "nn" || $estadohab_cond == "ep" || $estadohab_cond == "ne")
      {
         $this->monta_condicao("estadoHab", $estadohab_cond, $estadohab, "", "estadohab");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_habitacion']['cond_pesq'] .= $this->NM_operador;
