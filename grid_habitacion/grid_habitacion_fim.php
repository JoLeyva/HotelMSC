...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_habitacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_habitacion"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_habitacion'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_habitacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_habitacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_habitacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_habitacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_habitacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_habitacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_habitacion']['embutida_filho'] as $ind => $sc_init)
          {
