...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idhabitacion";$Nm_numeric[] = "idtipohab";$Nm_numeric[] = "estadohab";$Nm_numeric[] = "idhabitacion";$Nm_numeric[] = "idtipohab";$Nm_numeric[] = "estadohab";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idhabitacion_cond" name="idhabitacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_idhabitacion'), this, 'idhabitacion')">
      ...
      <br><span id="id_hide_idhabitacion"  <?php echo $str_hide_idhabitacion?>><INPUT  type="text" id="SC_idhabitacion" name="idhabitacion" value="<?php echo NM_encode_input($idhabitacion) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nrohab_cond" name="nrohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nrohab'), this, 'nrohab')">
      ...
      <br><span id="id_hide_nrohab"  <?php echo $str_hide_nrohab?>><?php
      if ($nrohab != "")
      {
      $nrohab_look = substr($this->Db->qstr($nrohab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_estadohab_cond" name="estadohab_cond" onChange="nm_campos_between(document.getElementById('id_vis_estadohab'), this, 'estadohab')">
      ...
      <br><span id="id_hide_estadohab"  <?php echo $str_hide_estadohab?>><INPUT  type="text" id="SC_estadohab" name="estadohab" value="<?php echo NM_encode_input($estadohab) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
