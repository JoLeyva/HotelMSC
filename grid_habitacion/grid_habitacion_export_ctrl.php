<?php
@session_start() ;
$_SESSION['scriptcase']['grid_habitacion']['sc_process_barr'] = true;
require_once('../grid_habitacion/index.php');
unset($_SESSION['scriptcase']['grid_habitacion']['sc_process_barr']);
$ExportCtrl = new grid_habitacion_export_control;
$ExportCtrl->Export_barr();

class grid_habitacion_export_control
{
