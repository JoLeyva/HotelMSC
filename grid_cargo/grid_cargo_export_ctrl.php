<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cargo']['sc_process_barr'] = true;
require_once('../grid_cargo/index.php');
unset($_SESSION['scriptcase']['grid_cargo']['sc_process_barr']);
$ExportCtrl = new grid_cargo_export_control;
$ExportCtrl->Export_barr();

class grid_cargo_export_control
{
