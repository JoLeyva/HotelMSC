...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hotel_____grid_cargo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hotel_____grid_cargo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cargo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cargo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cargo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cargo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cargo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cargo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cargo']['embutida_filho'] as $ind => $sc_init)
          {
