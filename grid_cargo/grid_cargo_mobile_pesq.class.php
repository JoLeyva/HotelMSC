...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcargo";$Nm_numeric[] = "sueldocargo";$Nm_numeric[] = "idcargo";$Nm_numeric[] = "sueldocargo";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombrecargo_cond" name="nombrecargo_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombrecargo'), this, 'nombrecargo')">
      ...
      <br><span id="id_hide_nombrecargo"  <?php echo $str_hide_nombrecargo?>><?php
      if ($nombrecargo != "")
      {
      $nombrecargo_look = substr($this->Db->qstr($nombrecargo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sueldocargo_cond" name="sueldocargo_cond" onChange="nm_campos_between(document.getElementById('id_vis_sueldocargo'), this, 'sueldocargo')">
