<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_report']['sc_process_barr'] = true;
require_once('../pdf_report/index.php');
unset($_SESSION['scriptcase']['pdf_report']['sc_process_barr']);
$ExportCtrl = new pdf_report_export_control;
$ExportCtrl->Export_barr();

class pdf_report_export_control
{
