...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Login"); } else { echo strip_tags("Login"); } ?></TITLE>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        <TD align="left" rowspan="2" class="scFormHeaderFont">
          <?php if ($this->Ini->Export_img_zip) {$this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . '/sys__NM__bg__NM__hotel.png';echo '<IMG SRC="sys__NM__bg__NM__hotel.png';}else{ echo '<IMG SRC="' . $this->Ini->path_imag_cab  . '/sys__NM__bg__NM__hotel.png';}?>" BORDER="0"/>
        </TD>
        <TD class="scFormHeaderFont">
          <?php if ($this->nmgp_opcao == "novo") { echo "Login"; } else { echo "Login"; } ?>
        </TD>
       </TR>
    ...
    <TR align="center">
     <TD>
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       ...
       <TR align="right" valign="middle">
        <TD class="scFormFooterFont">
          <?php echo "Scripcase Proyect v. 2.1" ?>
        </TD>
       </TR>
      </TABLE>
     </TD>
