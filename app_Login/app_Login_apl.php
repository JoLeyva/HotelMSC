...
unset($_SESSION['scriptcase']['sc_apl_seg']);unset($_SESSION['scriptcase']['pass']);unset($_SESSION['usr_login']);
 ...
 unset($_SESSION['usr_perfil']);
 unset($this->sc_temp_usr_perfil);
;
...
$sql = "SELECT 
		...
		u.email, 
        g.description
	      FROM sec_users u inner join sec_users_groups ug on u.login=ug.login inner join sec_groups g on ug.group_id=g.group_id   
