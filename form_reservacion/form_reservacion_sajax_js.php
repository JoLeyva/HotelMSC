  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reservacion" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_reservacion_validate_idreservacion()
  {
    var nomeCampo_idreservacion = "idreservacion";
    var var_idreservacion = scAjaxGetFieldHidden(nomeCampo_idreservacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_validate_idreservacion(var_idreservacion, var_script_case_init, do_ajax_form_reservacion_validate_idreservacion_cb);
  } // do_ajax_form_reservacion_validate_idreservacion

  function do_ajax_form_reservacion_validate_idreservacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_idreservacion_cb

  // ---------- Validate idcliente
  function do_ajax_form_reservacion_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_reservacion_validate_idcliente_cb);
  } // do_ajax_form_reservacion_validate_idcliente

  function do_ajax_form_reservacion_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_idcliente_cb

  // ---------- Validate idempleado
  function do_ajax_form_reservacion_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldSelect(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_reservacion_validate_idempleado_cb);
  } // do_ajax_form_reservacion_validate_idempleado

  function do_ajax_form_reservacion_validate_idempleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_idempleado_cb

  // ---------- Validate fechares
  function do_ajax_form_reservacion_validate_fechares()
  {
    ...
    setTimeout(function() {
      var var_fechares = scAjaxGetFieldText(nomeCampo_fechares);
      x_ajax_form_reservacion_validate_fechares(var_fechares, var_script_case_init, do_ajax_form_reservacion_validate_fechares_cb);
    }, 200);
  } // do_ajax_form_reservacion_validate_fechares

  function do_ajax_form_reservacion_validate_fechares_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_fechares_cb

  // ---------- Validate fechallegada
  function do_ajax_form_reservacion_validate_fechallegada()
  {
    ...
    setTimeout(function() {
      var var_fechallegada = scAjaxGetFieldText(nomeCampo_fechallegada);
      x_ajax_form_reservacion_validate_fechallegada(var_fechallegada, var_script_case_init, do_ajax_form_reservacion_validate_fechallegada_cb);
    }, 200);
  } // do_ajax_form_reservacion_validate_fechallegada

  function do_ajax_form_reservacion_validate_fechallegada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_fechallegada_cb

  // ---------- Validate nrodiasres
  function do_ajax_form_reservacion_validate_nrodiasres()
  {
    var nomeCampo_nrodiasres = "nrodiasres";
    var var_nrodiasres = scAjaxGetFieldText(nomeCampo_nrodiasres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_validate_nrodiasres(var_nrodiasres, var_script_case_init, do_ajax_form_reservacion_validate_nrodiasres_cb);
  } // do_ajax_form_reservacion_validate_nrodiasres

  function do_ajax_form_reservacion_validate_nrodiasres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_nrodiasres_cb

  // ---------- Validate nropersonasres
  function do_ajax_form_reservacion_validate_nropersonasres()
  {
    var nomeCampo_nropersonasres = "nropersonasres";
    var var_nropersonasres = scAjaxGetFieldText(nomeCampo_nropersonasres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_validate_nropersonasres(var_nropersonasres, var_script_case_init, do_ajax_form_reservacion_validate_nropersonasres_cb);
  } // do_ajax_form_reservacion_validate_nropersonasres

  function do_ajax_form_reservacion_validate_nropersonasres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_validate_nropersonasres_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_reservacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_reservacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_reservacion_submit_form(var_idreservacion, var_idcliente, var_idempleado, var_fechares, var_fechallegada, var_nrodiasres, var_nropersonasres, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_reservacion_submit_form_cb);
  } // do_ajax_form_reservacion_submit_form

  function do_ajax_form_reservacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_reservacion_submit_form_cb_after_alert);
  } // do_ajax_form_reservacion_submit_form_cb
  function do_ajax_form_reservacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_reservacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_reservacion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_reservacion_navigate_form, function() {});
    } else {
      perform_ajax_form_reservacion_navigate_form();
    }
  }

  function perform_ajax_form_reservacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_reservacion_navigate_form(var_idreservacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reservacion_navigate_form_cb);
  } // do_ajax_form_reservacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reservacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_reservacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_reservacion_navigate_form_cb_after_alert);
  } // do_ajax_form_reservacion_navigate_form_cb
  function do_ajax_form_reservacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_reservacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_reservacion_navigate_form_cb_after_alert

  function sc_hide_form_reservacion_form()
  {
