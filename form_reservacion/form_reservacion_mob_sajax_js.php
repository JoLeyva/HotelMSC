  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reservacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_reservacion_mob_form();
	}
...
?>
  ...
  // ---------- Validate idreservacion
  function do_ajax_form_reservacion_mob_validate_idreservacion()
  {
    var nomeCampo_idreservacion = "idreservacion";
    var var_idreservacion = scAjaxGetFieldHidden(nomeCampo_idreservacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_mob_validate_idreservacion(var_idreservacion, var_script_case_init, do_ajax_form_reservacion_mob_validate_idreservacion_cb);
  } // do_ajax_form_reservacion_mob_validate_idreservacion

  function do_ajax_form_reservacion_mob_validate_idreservacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idreservacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_idreservacion_cb

  // ---------- Validate idcliente
  function do_ajax_form_reservacion_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_reservacion_mob_validate_idcliente_cb);
  } // do_ajax_form_reservacion_mob_validate_idcliente

  function do_ajax_form_reservacion_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_idcliente_cb

  // ---------- Validate idempleado
  function do_ajax_form_reservacion_mob_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldSelect(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_mob_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_reservacion_mob_validate_idempleado_cb);
  } // do_ajax_form_reservacion_mob_validate_idempleado

  function do_ajax_form_reservacion_mob_validate_idempleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_idempleado_cb

  // ---------- Validate fechares
  function do_ajax_form_reservacion_mob_validate_fechares()
  {
    var nomeCampo_fechares = "fechares";
    var var_fechares = scAjaxGetFieldText(nomeCampo_fechares);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechares = scAjaxGetFieldText(nomeCampo_fechares);
      x_ajax_form_reservacion_mob_validate_fechares(var_fechares, var_script_case_init, do_ajax_form_reservacion_mob_validate_fechares_cb);
    }, 200);
  } // do_ajax_form_reservacion_mob_validate_fechares

  function do_ajax_form_reservacion_mob_validate_fechares_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechares";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_fechares_cb

  // ---------- Validate fechallegada
  function do_ajax_form_reservacion_mob_validate_fechallegada()
  {
    var nomeCampo_fechallegada = "fechallegada";
    var var_fechallegada = scAjaxGetFieldText(nomeCampo_fechallegada);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechallegada = scAjaxGetFieldText(nomeCampo_fechallegada);
      x_ajax_form_reservacion_mob_validate_fechallegada(var_fechallegada, var_script_case_init, do_ajax_form_reservacion_mob_validate_fechallegada_cb);
    }, 200);
  } // do_ajax_form_reservacion_mob_validate_fechallegada

  function do_ajax_form_reservacion_mob_validate_fechallegada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechallegada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_fechallegada_cb

  // ---------- Validate nrodiasres
  function do_ajax_form_reservacion_mob_validate_nrodiasres()
  {
    var nomeCampo_nrodiasres = "nrodiasres";
    var var_nrodiasres = scAjaxGetFieldText(nomeCampo_nrodiasres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_mob_validate_nrodiasres(var_nrodiasres, var_script_case_init, do_ajax_form_reservacion_mob_validate_nrodiasres_cb);
  } // do_ajax_form_reservacion_mob_validate_nrodiasres

  function do_ajax_form_reservacion_mob_validate_nrodiasres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nrodiasres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_nrodiasres_cb

  // ---------- Validate nropersonasres
  function do_ajax_form_reservacion_mob_validate_nropersonasres()
  {
    var nomeCampo_nropersonasres = "nropersonasres";
    var var_nropersonasres = scAjaxGetFieldText(nomeCampo_nropersonasres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reservacion_mob_validate_nropersonasres(var_nropersonasres, var_script_case_init, do_ajax_form_reservacion_mob_validate_nropersonasres_cb);
  } // do_ajax_form_reservacion_mob_validate_nropersonasres

  function do_ajax_form_reservacion_mob_validate_nropersonasres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nropersonasres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reservacion_mob_validate_nropersonasres_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_reservacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_reservacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idreservacion = scAjaxGetFieldHidden("idreservacion");
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_idempleado = scAjaxGetFieldSelect("idempleado");
    var var_fechares = scAjaxGetFieldText("fechares");
    var var_fechallegada = scAjaxGetFieldText("fechallegada");
    var var_nrodiasres = scAjaxGetFieldText("nrodiasres");
    var var_nropersonasres = scAjaxGetFieldText("nropersonasres");
    ...
    scAjaxProcOn();
    x_ajax_form_reservacion_mob_submit_form(var_idreservacion, var_idcliente, var_idempleado, var_fechares, var_fechallegada, var_nrodiasres, var_nropersonasres, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_reservacion_mob_submit_form_cb);
  } // do_ajax_form_reservacion_mob_submit_form

  function do_ajax_form_reservacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idreservacion");
      scAjaxHideErrorDisplay("idcliente");
      scAjaxHideErrorDisplay("idempleado");
      scAjaxHideErrorDisplay("fechares");
      scAjaxHideErrorDisplay("fechallegada");
      scAjaxHideErrorDisplay("nrodiasres");
      scAjaxHideErrorDisplay("nropersonasres");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_reservacion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_reservacion_mob_submit_form_cb
  function do_ajax_form_reservacion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_reservacion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_reservacion_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_reservacion_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_reservacion_mob_navigate_form();
    }
  }

  function perform_ajax_form_reservacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nrodiasres");
    scAjaxHideErrorDisplay("nropersonasres");
    var var_idreservacion = document.F2.idreservacion.value;
    ...
    scAjaxProcOn();
    x_ajax_form_reservacion_mob_navigate_form(var_idreservacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reservacion_mob_navigate_form_cb);
  } // do_ajax_form_reservacion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reservacion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_reservacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idreservacion.value = scAjaxGetKeyValue("idreservacion");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_reservacion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_reservacion_mob_navigate_form_cb
  function do_ajax_form_reservacion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_reservacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_reservacion_mob_navigate_form_cb_after_alert

  function sc_hide_form_reservacion_mob_form()
  {
  ...
  ajax_field_list[0] = "idreservacion";
  ajax_field_list[1] = "idcliente";
  ajax_field_list[2] = "idempleado";
  ajax_field_list[3] = "fechares";
  ajax_field_list[4] = "fechallegada";
  ajax_field_list[5] = "nrodiasres";
  ajax_field_list[6] = "nropersonasres";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idreservacion": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcliente": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idempleado": {"label": "Empleado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechares": {"label": "Fecha Reservada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechallegada": {"label": "Fecha Llegada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nrodiasres": {"label": "Días Reservados", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nropersonasres": {"label": "Cantidad de Personas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idreservacion": new Array(),
    "idcliente": new Array(),
    "idempleado": new Array(),
    "fechares": new Array(),
    "fechallegada": new Array(),
    "nrodiasres": new Array(),
    "nropersonasres": new Array()
  };
  ajax_field_mult["idreservacion"][1] = "idreservacion";
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["idempleado"][1] = "idempleado";
  ajax_field_mult["fechares"][1] = "fechares";
  ajax_field_mult["fechallegada"][1] = "fechallegada";
  ajax_field_mult["nrodiasres"][1] = "nrodiasres";
  ajax_field_mult["nropersonasres"][1] = "nropersonasres";

  var ajax_field_id = {
    "idreservacion": new Array("hidden_field_label_idreservacion", "hidden_field_data_idreservacion"),
    ...
    "fechares": new Array("hidden_field_label_fechares", "hidden_field_data_fechares"),
    "fechallegada": new Array("hidden_field_label_fechallegada", "hidden_field_data_fechallegada"),
    "nrodiasres": new Array("hidden_field_label_nrodiasres", "hidden_field_data_nrodiasres"),
    "nropersonasres": new Array("hidden_field_label_nropersonasres", "hidden_field_data_nropersonasres")
  };
