  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_habitacion" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idhabitacion_
  function do_ajax_form_habitacion_validate_idhabitacion_(iNumLinha)
  {
    var nomeCampo_idhabitacion_ = "idhabitacion_" + iNumLinha;
    var var_idhabitacion_ = scAjaxGetFieldHidden(nomeCampo_idhabitacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_habitacion_validate_idhabitacion_(var_idhabitacion_, iNumLinha, var_script_case_init, do_ajax_form_habitacion_validate_idhabitacion__cb);
  } // do_ajax_form_habitacion_validate_idhabitacion_

  function do_ajax_form_habitacion_validate_idhabitacion__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idhabitacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idhabitacion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idhabitacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idhabitacion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_habitacion_validate_idhabitacion__cb

  // ---------- Validate nrohab_
  function do_ajax_form_habitacion_validate_nrohab_(iNumLinha)
  {
    var nomeCampo_nrohab_ = "nrohab_" + iNumLinha;
    var var_nrohab_ = scAjaxGetFieldHidden(nomeCampo_nrohab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_habitacion_validate_nrohab_(var_nrohab_, iNumLinha, var_script_case_init, do_ajax_form_habitacion_validate_nrohab__cb);
  } // do_ajax_form_habitacion_validate_nrohab_

  function do_ajax_form_habitacion_validate_nrohab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nrohab_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nrohab_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nrohab_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nrohab_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_habitacion_validate_nrohab__cb

  // ---------- Validate idtipohab_
  function do_ajax_form_habitacion_validate_idtipohab_(iNumLinha)
  {
    var nomeCampo_idtipohab_ = "idtipohab_" + iNumLinha;
    var var_idtipohab_ = scAjaxGetFieldSelect(nomeCampo_idtipohab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_habitacion_validate_idtipohab_(var_idtipohab_, iNumLinha, var_script_case_init, do_ajax_form_habitacion_validate_idtipohab__cb);
  } // do_ajax_form_habitacion_validate_idtipohab_

  function do_ajax_form_habitacion_validate_idtipohab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idtipohab_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtipohab_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idtipohab_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtipohab_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_habitacion_validate_idtipohab__cb

  // ---------- Validate estadohab_
  function do_ajax_form_habitacion_validate_estadohab_(iNumLinha)
  {
    var nomeCampo_estadohab_ = "estadohab_" + iNumLinha;
    var var_estadohab_ = scAjaxGetFieldSelect(nomeCampo_estadohab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_habitacion_validate_estadohab_(var_estadohab_, iNumLinha, var_script_case_init, do_ajax_form_habitacion_validate_estadohab__cb);
  } // do_ajax_form_habitacion_validate_estadohab_

  function do_ajax_form_habitacion_validate_estadohab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "estadohab_" + iLineNumber;
    }
    else
    {
      sFieldValid = "estadohab_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "estadohab_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "estadohab_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_habitacion_validate_estadohab__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_habitacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_habitacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_habitacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_habitacion_add_new_line_cb);
  } // do_ajax_form_habitacion_add_new_line

  function do_ajax_form_habitacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_habitacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_habitacion_backup_line(iNumLinha)
  {
    var var_idhabitacion_ = scAjaxGetFieldHidden("idhabitacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_habitacion_backup_line(var_idhabitacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_habitacion_backup_line_cb);
  } // do_ajax_form_habitacion_backup_line

  function do_ajax_form_habitacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_habitacion_backup_line_cb

  function do_ajax_form_habitacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_habitacion_cancel_insert

  function do_ajax_form_habitacion_cancel_update(iSeqVert)
  {
    do_ajax_form_habitacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_habitacion_cancel_update

  function do_ajax_form_habitacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_habitacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_habitacion_table_refresh()
  {
    var var_idhabitacion_ = document.F2.idhabitacion_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_habitacion_table_refresh(var_idhabitacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_habitacion_table_refresh_cb);
  } //  do_ajax_form_habitacion_table_refresh

  function do_ajax_form_habitacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idhabitacion_.value = scAjaxGetKeyValue("idhabitacion_");
    ...
    scAjaxAlert(do_ajax_form_habitacion_table_refresh_cb_after_alert);
  } // do_ajax_form_habitacion_table_refresh_cb
  function do_ajax_form_habitacion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_habitacion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_habitacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_habitacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idhabitacion_ = scAjaxGetFieldHidden("idhabitacion_" + iNumLinha);
    var var_nrohab_ = scAjaxGetFieldHidden("nrohab_" + iNumLinha);
    var var_idtipohab_ = scAjaxGetFieldSelect("idtipohab_" + iNumLinha);
    var var_estadohab_ = scAjaxGetFieldSelect("estadohab_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_habitacion_submit_form(var_idhabitacion_, var_nrohab_, var_idtipohab_, var_estadohab_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_habitacion_submit_form_cb);
  } // do_ajax_form_habitacion_submit_form

  function do_ajax_form_habitacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idhabitacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nrohab_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idtipohab_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("estadohab_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_habitacion_submit_form_cb_after_alert);
  } // do_ajax_form_habitacion_submit_form_cb
  function do_ajax_form_habitacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_habitacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_habitacion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_habitacion_navigate_form, function() {});
    } else {
      perform_ajax_form_habitacion_navigate_form();
    }
  }

  function perform_ajax_form_habitacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_habitacion_cancel_insert(sc_form_habitacion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idhabitacion_" + iNavForm);
      scAjaxHideErrorDisplay("nrohab_" + iNavForm);
      scAjaxHideErrorDisplay("idtipohab_" + iNavForm);
      scAjaxHideErrorDisplay("estadohab_" + iNavForm);
    }
    var var_idhabitacion_ = document.F2.idhabitacion_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_habitacion_navigate_form(var_idhabitacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_habitacion_navigate_form_cb);
  } // do_ajax_form_habitacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_habitacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_habitacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idhabitacion_.value = scAjaxGetKeyValue("idhabitacion_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_habitacion_navigate_form_cb_after_alert);
  } // do_ajax_form_habitacion_navigate_form_cb
  function do_ajax_form_habitacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_habitacion_navigate_form_cb_after_alert

    function sc_form_habitacion_get_last_line_number()
    {
    ...
    } //sc_form_habitacion_get_last_line_number 

  function sc_hide_form_habitacion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idhabitacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nrohab_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idtipohab_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "estadohab_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idhabitacion_" + iNumLinha] = {"label": "Id Habitacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nrohab_" + iNumLinha] = {"label": "Nro Hab<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idtipohab_" + iNumLinha] = {"label": "Tipo Habitacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["estadohab_" + iNumLinha] = {"label": "Estado Hab<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idhabitacion_"][iNumLinha] = "idhabitacion_" + iNumLinha;
    ajax_field_mult["nrohab_"][iNumLinha] = "nrohab_" + iNumLinha;
    ajax_field_mult["idtipohab_"][iNumLinha] = "idtipohab_" + iNumLinha;
    ajax_field_mult["estadohab_"][iNumLinha] = "estadohab_" + iNumLinha;
    ajax_field_id["idhabitacion_" + iNumLinha] = new Array("hidden_field_label_idhabitacion_", "hidden_field_data_idhabitacion_" + iNumLinha);
    ajax_field_id["nrohab_" + iNumLinha] = new Array("hidden_field_label_nrohab_", "hidden_field_data_nrohab_" + iNumLinha);
    ajax_field_id["idtipohab_" + iNumLinha] = new Array("hidden_field_label_idtipohab_", "hidden_field_data_idtipohab_" + iNumLinha);
    ajax_field_id["estadohab_" + iNumLinha] = new Array("hidden_field_label_estadohab_", "hidden_field_data_estadohab_" + iNumLinha);
    ajax_error_count["idhabitacion_" + iNumLinha] = "off";
    ajax_error_count["nrohab_" + iNumLinha] = "off";
    ajax_error_count["idtipohab_" + iNumLinha] = "off";
    ajax_error_count["estadohab_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idhabitacion_" + iNumLinha] = "on";
    ajax_read_only["nrohab_" + iNumLinha] = "off";
    ajax_read_only["idtipohab_" + iNumLinha] = "off";
    ajax_read_only["estadohab_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idhabitacion_" + iNumLinha] = "on";
    ajax_read_only["nrohab_" + iNumLinha] = "on";
    ajax_read_only["idtipohab_" + iNumLinha] = "on";
    ajax_read_only["estadohab_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idhabitacion_" + iNumLinha] = null;
    ajax_error_list["nrohab_" + iNumLinha] = null;
    ajax_error_list["idtipohab_" + iNumLinha] = null;
    ajax_error_list["estadohab_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idhabitacion_": new Array(),
    "nrohab_": new Array(),
    "idtipohab_": new Array(),
    "estadohab_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idhabitacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idhabitacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idhabitacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idhabitacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idhabitacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nrohab_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nrohab_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nrohab_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nrohab_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nrohab_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idtipohab_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtipohab_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtipohab_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtipohab_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtipohab_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["estadohab_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["estadohab_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["estadohab_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["estadohab_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["estadohab_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idhabitacion_'])) ? $this->nmgp_cmp_readonly['idhabitacion_'] : 'on';
?>
    scAjaxFieldRead("idhabitacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nrohab_'])) ? $this->nmgp_cmp_readonly['nrohab_'] : 'off';
?>
    scAjaxFieldRead("nrohab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtipohab_'])) ? $this->nmgp_cmp_readonly['idtipohab_'] : 'off';
?>
    scAjaxFieldRead("idtipohab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['estadohab_'])) ? $this->nmgp_cmp_readonly['estadohab_'] : 'off';
?>
    scAjaxFieldRead("estadohab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idhabitacion_" + iSeq, "on");
    scAjaxFieldRead("nrohab_" + iSeq, "on");
    scAjaxFieldRead("idtipohab_" + iSeq, "on");
    scAjaxFieldRead("estadohab_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idhabitacion_" + iRow] || "on" == ajax_error_count["nrohab_" + iRow] || "on" == ajax_error_count["idtipohab_" + iRow] || "on" == ajax_error_count["estadohab_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idhabitacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nrohab_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtipohab_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_estadohab_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idhabitacion_" + iRow] && "off" == ajax_error_count["nrohab_" + iRow] && "off" == ajax_error_count["idtipohab_" + iRow] && "off" == ajax_error_count["estadohab_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idhabitacion_" + iRow] = "off";
        ajax_error_count["nrohab_" + iRow] = "off";
        ajax_error_count["idtipohab_" + iRow] = "off";
        ajax_error_count["estadohab_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idhabitacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nrohab_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idtipohab_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_estadohab_" + iRow).removeClass("scFormErrorLine");
    }
  }
